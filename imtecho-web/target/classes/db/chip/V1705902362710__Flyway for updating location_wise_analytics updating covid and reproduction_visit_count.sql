-- New flyway for updating location_wise_analytics updating covid and reproduction_visit_count
...
add column if not exists covid_count_by_location  integer,
add column if not exists rep_modification_visit_count_by_location  integer,
