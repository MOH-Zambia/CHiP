...
'DELETE FROM public.internationalization_label_master WHERE key = '|| quote_nullable(OLD.key) ||' and language = '|| quote_nullable(OLD.language) ||' and app_name = '|| quote_nullable(OLD.app_name) ||' and country = '|| quote_nullable(OLD.country) ||';'
);
end if;
