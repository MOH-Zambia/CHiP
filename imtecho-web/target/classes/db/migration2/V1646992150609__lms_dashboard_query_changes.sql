DELETE FROM QUERY_MASTER WHERE CODE='lms_dashboard_retrieve_comprehension_effectiveness';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'69dec614-b24a-4e52-8b94-b806c921ec25', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_comprehension_effectiveness',
'quizId,locationId,courseId',
...
INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'fe74a3c5-5c52-4d64-bb15-2bb52d774a85', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_course_completors',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
...
INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'45bc05a7-726c-41cf-a18c-c39f6cca6f76', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_course_engagement',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
	...
	from enrolled_users
    inner join location_user on location_user.user_id=enrolled_users.enrolled_user_id
...
DELETE FROM QUERY_MASTER WHERE CODE='lms_dashboard_retrieve_daywise_engagement_by_lesson';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'484b52a2-9d80-4192-8171-07f808dfb45b', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_daywise_engagement_by_lesson',
'locationId,lessonId,time',
'with location_user as(
...
DELETE FROM QUERY_MASTER WHERE CODE='lms_dashboard_retrieve_daywise_engagement_by_module';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'67ce718e-b267-4013-96da-005186b96914', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_daywise_engagement_by_module',
'topicId,locationId,time',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
        left join um_user_location on um_user_location.loc_id = location_hierchy_closer_det.child_id
...
INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'8f76045a-31df-4d82-af85-71be977e10fb', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_learning_hours_by_course_id',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
...
INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'85dc642c-f05b-412c-84bb-b6763c1e464c', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_lessons_by_course_id',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
...
INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'e338408e-f1f5-4d51-9048-787ec1ff920f', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_modules_by_course_id',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
...
DELETE FROM QUERY_MASTER WHERE CODE='lms_dashboard_retrieve_not_accessed_7_days';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'e03078ac-3c80-4426-a44b-04948b89d733', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_not_accessed_7_days',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
...
DELETE FROM QUERY_MASTER WHERE CODE='lms_dashboard_retrieve_quizzes_by_course_id';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'60eb2f3d-375c-4db0-ae79-504f37863f3b', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_quizzes_by_course_id',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
...
DELETE FROM QUERY_MASTER WHERE CODE='lms_dashboard_retrieve_top_scorers';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'60b8b838-b241-4892-8b52-c77f0e362a72', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_top_scorers',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
...
DELETE FROM QUERY_MASTER WHERE CODE='lms_dashboard_retrieve_userwise_quiz_trend_by_quiz_id';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'77ec6a25-67d9-488f-b578-ff557216f9e2', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_userwise_quiz_trend_by_quiz_id',
'quizId,locationId,time',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
        left join um_user_location on um_user_location.loc_id = location_hierchy_closer_det.child_id
...
INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'b4563d5c-0f2c-4ef6-b3cc-8ef156098955', 97091,  current_date , 97091,  current_date , 'lms_dashboard_retrieve_userwise_watch_hours_by_course_id',
'locationId,courseId',
'with location_user as(
    select user_id
    from location_hierchy_closer_det
