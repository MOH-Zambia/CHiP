DELETE FROM QUERY_MASTER WHERE CODE='fp_search_by_abha_address';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'512a7ab5-78a0-42a5-8c91-9f5a1a91ac2e', 97632,  current_date , 97632,  current_date , 'fp_search_by_abha_address',
...
'with member_detail as (
	...
	where imt_member.health_id = #abhaAddress# and imt_member.marital_status = 629 and imt_member.gender = ''F''
...
'Family Planning search by abha address',
true, 'ACTIVE');