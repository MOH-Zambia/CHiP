...
VALUES (
'789c459f-dabd-4c09-8327-44323becd39f', 97070,  current_date , 97070,  current_date , 'retrival_listvalues_mobile',
...
select values.id as "idOfValue", fields.form as "formCode",
	fields.field as "field", fields.field_type as "fieldType", values.value as value, values.list_order as order,
...
-- added column in list value

alter table listvalue_field_value_detail
drop column if exists list_order,
add column list_order integer;

update system_configuration set key_value = '57' where system_key = 'MOBILE_FORM_VERSION';