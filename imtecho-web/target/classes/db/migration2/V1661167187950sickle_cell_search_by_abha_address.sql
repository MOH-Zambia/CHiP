DELETE FROM QUERY_MASTER WHERE CODE='sickle_cell_search_by_abha_address';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state )
VALUES (
'df01f06b-180d-43d9-a670-ce1896a2768f', 97632,  current_date , 97632,  current_date , 'sickle_cell_search_by_abha_address',
...
where health_id in (#abhaAddress#)
