...
drop column if exists suggested_health_infra,
add column suggested_health_infra integer;


-- Change in insert_lab_test function and added some field in admission detail.
...
INSERT INTO public.QUERY_MASTER ( created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state ) 
VALUES ( 
75398,  current_date , 75398,  current_date , 'covid19_retrieve_covid_hospital_location', 
 null, 
'select * from location_master where type in (''D'',''C'') order by name', 
null, 
true, 'ACTIVE');
...
INSERT INTO public.QUERY_MASTER ( created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state ) 
VALUES ( 
75398,  current_date , 75398,  current_date , 'covid19_retrieve_lab_location', 
 null, 
'select * from location_master where type in (''D'',''C'') order by name', 
null, 
true, 'ACTIVE');
