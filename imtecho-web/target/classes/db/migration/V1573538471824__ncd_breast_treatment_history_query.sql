...
values(1, current_date, 'ncd_breast_treatment_history', 'memberId', '
...
inner join ncd_member_referral on ncd_member_breast_detail.referral_id = ncd_member_referral.id
...
', true, 'ACTIVE', 'To retrieve breast disease treatment history of patient.');