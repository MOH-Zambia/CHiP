...
update menu_config set group_id = (select id from menu_group where group_name = 'Facility Data Entry' and group_type = 'manage') where menu_name = 'Out-Patient Treatment (OPD)';
