...
values(1, current_date, 'ncd_cervical_treatment_history', 'memberId', '
...
inner join ncd_member_referral on ncd_member_cervical_detail.referral_id = ncd_member_referral.id
...
', true, 'ACTIVE', 'To retrieve cervical disease treatment history of patient.');