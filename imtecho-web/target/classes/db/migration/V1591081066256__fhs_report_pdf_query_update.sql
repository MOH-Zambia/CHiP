...
and case when #is_pregnant_req# = true then is_pregnant is true else true end
and case when #is_less_then_five_req# = true then dob > now() - interval ''5 years'' else true end
