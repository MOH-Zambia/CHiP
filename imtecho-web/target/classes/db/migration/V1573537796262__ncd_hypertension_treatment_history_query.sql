...
values(1, current_date, 'ncd_hypertension_treatment_history', 'memberId', '
...
inner join ncd_member_referral on ncd_member_hypertension_detail.referral_id = ncd_member_referral.id
...
', true, 'ACTIVE', 'To retrieve hypertension disease treatment history of patient.');