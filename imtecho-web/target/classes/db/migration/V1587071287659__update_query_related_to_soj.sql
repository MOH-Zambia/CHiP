...
and cast(now() as date) - cast( admission_date as date) between #days# and #to_days# and cad_status not in (''DISCHARGE'',''DEATH'');',
null,
true, 'ACTIVE');
...
'offset,limit,location_id,health_infra_id,search_text',
'with analytics as(
select
