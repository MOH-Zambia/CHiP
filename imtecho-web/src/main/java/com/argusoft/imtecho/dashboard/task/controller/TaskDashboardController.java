...
// */
//package com.argusoft.imtecho.dashboard.task.controller;
//
...
////    }
//
//    @RequestMapping(value="/getnotificationactions",method = RequestMethod.GET)
//    public List<LinkedHashMap<String, Object>> getNotificationActions(@RequestParam("notificationTypeId") Integer notificationTypeId){
//        return webTaskDashboardService.getNotificationActions(notificationTypeId);
//    }
//}
