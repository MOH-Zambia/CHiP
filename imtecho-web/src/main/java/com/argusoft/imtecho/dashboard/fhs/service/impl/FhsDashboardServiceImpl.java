 ...
 */
package com.argusoft.imtecho.dashboard.fhs.service.impl;
...
import com.argusoft.imtecho.dashboard.fhs.service.FhsDashboardService;
...
public class  FhsDashboardServiceImpl implements FhsDashboardService {
    ...
    public String getLastUpdateTime() {
        return systemConfigurationService
                .retrieveSystemConfigurationByKey(com.argusoft.imtecho.common.util.ConstantUtil.FHS_LAST_UPDATE_TIME_SYSTEM_KEY).getKeyValue();
    }
