 ...
 */
package com.argusoft.imtecho.notification.model;
...
public class TechoNotificationMaster extends EntityAuditInfo implements Serializable {
    ...
    @Column(name = "location_hierchy_id")
    private Integer locationHierchyId;
    @Column(name = "user_id")
    ...
    public Integer getLocationHierchyId() {
        return locationHierchyId;
    }

    public void setLocationHierchyId(Integer locationHierchyId) {
        this.locationHierchyId = locationHierchyId;
    }
