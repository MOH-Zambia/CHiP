...
public class HealthInfraTypeLocationBean {
    private Integer healthInfraTypeId;
    private String healthInfraTypeName;
    private Integer locationLevel;

    public Integer getHealthInfraTypeId() {
        return healthInfraTypeId;
    }

    public void setHealthInfraTypeId(Integer healthInfraTypeId) {
