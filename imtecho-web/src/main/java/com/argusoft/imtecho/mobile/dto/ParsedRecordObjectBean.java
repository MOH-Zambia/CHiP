...
public class ParsedRecordObjectBean {
    ...
    private JSONObject answerRecord;
    ...
    public void setAnswerRecord(JSONObject answerRecord) {
    ...
    public enum ParsedRecordBeanComparator implements Comparator<ParsedRecordObjectBean> {
        SORT_RELATIVE_ID {
            @Override
            public int compare(ParsedRecordObjectBean o1, ParsedRecordObjectBean o2) {
        ...
        public static Comparator<ParsedRecordObjectBean> getComparator(final ParsedRecordBeanComparator... multipleOptions) {
            return (o1, o2) -> {
