...
public class SickleCellFamilyDataBean {
    ...
    private List<SickleCellMemberDataBean> members = new ArrayList<>();
...
//    private Boolean anganwadiUpdateFlag;
    ...
    public List<SickleCellMemberDataBean> getMembers() {
        return members;
    }

    public void setMembers(List<SickleCellMemberDataBean> members) {
