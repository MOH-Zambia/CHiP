...
public class MobileApiPathConstants {
    ...
    public static final String TEMP_API = "tempApi";
    ...
    public static final String TECHO_DATABEAN_RECORD_ENTRY_MOBILE_TO_DB_SERVER = "techodatabeanrecordentryfrommobiletodbservernew";
    ...
    public static final String TECHO_MINIO_OAUTH = "minioauth";
