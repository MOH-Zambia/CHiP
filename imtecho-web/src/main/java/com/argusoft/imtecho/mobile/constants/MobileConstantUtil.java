...
import com.argusoft.imtecho.fhs.util.CroneService;
...
public class MobileConstantUtil {
    ...
    public static final String IMMUNISATION_MR_2 = "MR_2";
    public static final String IMMUNISATION_JE = "JE";
    public static final String IMMUNISATION_IPV = "IPV";
    ...
    public static final String MEBENDAZOLE = "MEBENDAZOLE";
    ...
    public static final String IMMUNISATION_ROUVAX_MR_1 = "ROUVAX_MR_1";
    public static final String IMMUNISATION_ROUVAX_MR_2 = "ROUVAX_MR_2";
