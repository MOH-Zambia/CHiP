...
public class MobUserInfoDataBean {
    ...
    private Long getLastLoginDate;

    public MobUserInfoDataBean(boolean authenticated, String contactNumber, Long dob, boolean firstTimeLogin, String languageCode, String loginFailureMsg, String password, Integer userContactId, String userRole, String username, String fName, String phNoOfPM, Integer id, String userToken, boolean isNagarPalikaUser, boolean isSmagTrained) {
    ...
    public Long getGetLastLoginDate() {
        return getLastLoginDate;
    }

    public void setGetLastLoginDate(Long getLastLoginDate) {
