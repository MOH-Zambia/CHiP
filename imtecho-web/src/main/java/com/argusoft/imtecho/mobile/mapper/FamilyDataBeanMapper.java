...
import com.argusoft.imtecho.fhs.dto.FamilyAdditionalInfo;
...
public class FamilyDataBeanMapper {
    ...
    public static FamilyDataBean convertFamilyEntityToFamilyDataBean(FamilyEntity family, List<MemberDataBean> members) {
        ...
        familyDataBean.setProvidingConsent(family.getIsProvidingConsent());
        familyDataBean.setVulnerabilityCriteria(family.getVulnerabilityCriteria());
        familyDataBean.setAnyoneTravelledForeign(family.getAnyoneTravelledForeign());
        familyDataBean.setResidenceStatus(family.getResidenceStatus());
        familyDataBean.setLatitude(family.getLatitude());
        familyDataBean.setLongitude(family.getLongitude());
        familyDataBean.setUuid(family.getFamilyUuid());
        familyDataBean.setEligibleChildrenCount(family.getEligibleChildrenCount());
