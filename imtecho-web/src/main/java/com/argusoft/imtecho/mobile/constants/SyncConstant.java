...
public class SyncConstant {
    ...
    public static final String SICKLE_CELL_FAMILY_BEAN = "SickleCellFamilyBean";
    ...
    public static final String NCD_MEMBER_BEAN = "NcdMemberBean";
    public static final String ANEMIA_MEMBER_BEAN = "AnemiaMemberBean";
    public static final String STOCK_INVENTORY_BEAN = "StockInventoryBean";
    public static final String OCR_FORMS_BEAN = "OcrFormBean";
    public static final String SURVEILLANCE_FAMILY_BEAN = "SurveillanceFamilyBean";
    public static final String HU_MEMBER_BEAN = "HUMemberBean";
