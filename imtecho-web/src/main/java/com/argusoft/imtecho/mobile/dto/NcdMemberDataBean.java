 ...
 * @author batul
 */
public class NcdMemberDataBean {
    ...
    public String getLastMoComment() {
        return lastMoComment;
    }

    public void setLastMoComment(String lastMoComment) {
        this.lastMoComment = lastMoComment;
    }
    ...
    public Boolean getMoConfirmedMentalHealth() {
        return moConfirmedMentalHealth;
    }

    public void setMoConfirmedMentalHealth(Boolean moConfirmedMentalHealth) {
        this.moConfirmedMentalHealth = moConfirmedMentalHealth;
    }
