...
public class LogInRequestParamDetailDto {
    ...
    private Long lastUpdateDateForOcrForms;
    ...
    public void setFreeSpaceMBapprovedBy(Integer freeSpaceMB) {
    ...
    public Long getLastUpdateDateForOcrForms() {
        return lastUpdateDateForOcrForms;
    }

    public void setLastUpdateDateForOcrForms(Long lastUpdateDateForOcrForms) {
        this.lastUpdateDateForOcrForms = lastUpdateDateForOcrForms;
    }
