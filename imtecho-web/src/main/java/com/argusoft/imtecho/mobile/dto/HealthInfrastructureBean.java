...
/**
 *
 * @author prateek on 2 Apr, 2019
 */
public class HealthInfrastructureBean {
    ...
    public Boolean getIsChiranjeevi() {
        return isChiranjeevi;
    }

    public void setIsChiranjeevi(Boolean isChiranjeevi) {
        this.isChiranjeevi = isChiranjeevi;
    }
