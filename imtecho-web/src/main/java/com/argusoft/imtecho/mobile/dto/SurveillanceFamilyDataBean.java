...
public class SurveillanceFamilyDataBean {
    ...
    private List<SurveillanceMemberDataBean> members = new ArrayList<>();
    ...
    public void setVerifiedFlag(Boolean verifiedFlag) {
        isVerifiedFlag = verifiedFlag;
    }

    public List<SurveillanceMemberDataBean> getMembers() {
        return members;
    }

    public void setMembers(List<SurveillanceMemberDataBean> members) {
