...
public class PncMapper {
    ...
    public static PncMaster convertPncMasterDtoToPncMaster(PncMasterDto pncMasterDto) {
        ...
        pncMaster.setLocationHierarchyId(pncMasterDto.getLocationHierarchyId());
        ...
        pncMaster.setNextServiceDate(pncMasterDto.getNextServiceDate());
        pncMaster.setCounselingDone(pncMasterDto.getCounselingDone());
    ...
    public static PncMotherMaster convertPncMotherDtoToPncMotherMaster(PncMotherDto pncMotherDto) {
        ...
        pncMotherMaster.setReceivedMebendazole(pncMotherDto.getReceivedMebendazole());
        pncMotherMaster.setTetanus1Date(pncMotherDto.getTetanus1GivenDate());
        pncMotherMaster.setTetanus2Date(pncMotherDto.getTetanus2GivenDate());
        pncMotherMaster.setTetanus3Date(pncMotherDto.getTetanus3GivenDate());
        ...
        pncMotherMaster.setTetanus4Date(pncMotherDto.getTetanus4Date());
        pncMotherMaster.setTetanus5Date(pncMotherDto.getTetanus5Date());
        pncMotherMaster.setCheckForBreastfeeding(pncMotherDto.getCheckForBreastfeeding());
        pncMotherMaster.setRemarks(pncMotherMaster.getRemarks());
    ...
    public static PncMotherDto convertPncMotherMasterToPncMotherDto(PncMotherMaster pncMotherMaster) {
        ...
        pncMotherDto.setReceivedMebendazole(pncMotherMaster.getReceivedMebendazole());
        pncMotherDto.setTetanus1GivenDate(pncMotherMaster.getTetanus1Date());
        pncMotherDto.setTetanus2GivenDate(pncMotherMaster.getTetanus2Date());
        pncMotherDto.setTetanus3GivenDate(pncMotherMaster.getTetanus3Date());
        ...
        pncMotherDto.setTetanus4Date(pncMotherMaster.getTetanus4Date());
        pncMotherDto.setTetanus5Date(pncMotherMaster.getTetanus5Date());
        pncMotherDto.setCheckForBreastfeeding(pncMotherMaster.getCheckForBreastfeeding());
        pncMotherDto.setPaymentType(pncMotherMaster.getPaymentType());
        pncMotherDto.setRemarks(pncMotherDto.getRemarks());
        return pncMotherDto;
    }
