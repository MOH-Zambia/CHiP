...
public class PncChildMaster extends EntityAuditInfo implements Serializable {
    ...
    @Column(name = "is_cpt_started")
    private Boolean isCptStarted;

    @Column(name = "is_eid_started")
    private Boolean isEidStarted;
    ...
    public Boolean getCptStarted() {
        return isCptStarted;
    }

    public void setCptStarted(Boolean cptStarted) {
        isCptStarted = cptStarted;
    }

    public Boolean getEidStarted() {
        return isEidStarted;
    }

    public void setEidStarted(Boolean eidStarted) {
        isEidStarted = eidStarted;
    }
