...
import com.argusoft.imtecho.rch.dao.AshaChildServiceDao;
import com.argusoft.imtecho.rch.model.AshaChildServiceMaster;
import com.argusoft.imtecho.rch.model.ImmunisationMaster;
import com.argusoft.imtecho.rch.service.AshaChildService;
...
public class AshaChildServiceImpl implements AshaChildService {
    ...
    public Integer storeChildServiceVisitForm(ParsedRecordBean parsedRecordBean, Map<String, String> keyAndAnswerMap, UserMaster user) {
        ...
        serviceMaster.setLocationHierarchyId(locationLevelHierarchy.getId());
