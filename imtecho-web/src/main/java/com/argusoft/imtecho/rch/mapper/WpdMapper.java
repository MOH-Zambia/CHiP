...
public class WpdMapper {
    ...
    public static WpdMotherMaster convertWpdMasterDtoToWpdMotherMaster(WpdMasterDto wpdMasterDto) {
        ...
        wpdMotherMaster.setLocationHierarchyId(wpdMasterDto.getLocationHierarchyId());
        ...
        wpdMotherMaster.setOxytocin(wpdMasterDto.getIsOxytocin() == null ? false : true);
        wpdMotherMaster.setHivDuringDelivery(wpdMasterDto.getHivDuringDelivery());
        wpdMotherMaster.setWasARTGiven(wpdMotherMaster.getWasARTGiven());
        wpdMotherMaster.setIsARTGivenDelivery(wpdMasterDto.getIsARTGivenDelivery());
        wpdMotherMaster.setIfaGiven(wpdMasterDto.getIsIfaGiven() == null ? false : true);
        ...
        wpdMotherMaster.setPaymentType(wpdMasterDto.getPaymentType());
        wpdMotherMaster.setRemarks(wpdMasterDto.getRemarks());
    ...
    public static WpdChildMaster convertWpdChildDtoToWpdChildMaster(WpdChildDto wpdChildDto) {
        ...
        if (wpdChildDto.getPregnancyOutcome().equals("LBIRTH") || wpdChildDto.getPregnancyOutcome().equals("SBIRTH")) {
            ...
            wpdChildMaster.setBabyBreatheAtBirth(wpdChildDto.getBabyBreatheAtBirth());
            ...
            wpdChildMaster.setVitaminK1Date(wpdChildDto.getVitaminK1Date());
            wpdChildMaster.setBreastfeedingInHealthCenter(wpdChildDto.getBreastfeedingInHealthCenter());
            wpdChildMaster.setBabyBreatheAtBirth(wpdChildDto.getBabyBreatheAtBirth());
            wpdChildMaster.setSkinToSkin(wpdChildDto.getSkinToSkin());
    ...
    public static WpdMotherDto convertWpdMotherMasterToWpdMotherMasterDto(WpdMotherMaster wpdMotherMaster) {
        ...
        wpdMotherDto.setIfaGiven(wpdMotherMaster.isIfaGiven());
        wpdMotherDto.setWasARTGiven(wpdMotherMaster.getWasARTGiven());
        wpdMotherDto.setARTGivenDelivery(wpdMotherMaster.getIsARTGivenDelivery());
        wpdMotherDto.setHivDuringDelivery(wpdMotherMaster.getHivDuringDelivery());
        ...
        wpdMotherDto.setPaymentType(wpdMotherMaster.getPaymentType());
        wpdMotherDto.setRemarks(wpdMotherDto.getRemarks());
        return wpdMotherDto;
    }
    ...
    public static WpdChildDto convertWpdChildMasterToWpdChildMasterDto(WpdChildMaster wpdChildMaster) {
        ...
        wpdChildDto.setBabyBreatheAtBirth(wpdChildMaster.getBabyBreatheAtBirth());
        ...
        wpdChildDto.setCreatedBy(wpdChildMaster.getCreatedBy());
        wpdChildDto.setModifiedBy(wpdChildMaster.getModifiedBy());
        wpdChildDto.setVitaminK1Date(wpdChildMaster.getVitaminK1Date());
        wpdChildDto.setBreastfeedingInHealthCenter(wpdChildMaster.getBreastfeedingInHealthCenter());
        wpdChildDto.setBabyBreatheAtBirth(wpdChildMaster.getBabyBreatheAtBirth());
        wpdChildDto.setSkinToSkin(wpdChildMaster.getSkinToSkin());
