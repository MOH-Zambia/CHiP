...
public class WpdChildMaster extends VisitCommonFields implements Serializable {
    ...
    @Column(name = "is_antiretroviral_therapy_started")
    private Boolean isAntiRetroViralTherapyStarted;
    ...
    @Column(name = "vitamin_k1_date")
    @Temporal(TemporalType.DATE)
    private Date vitaminK1Date;

    @Column(name = "exclusive_breastfeeding_in_health_center")
    private Boolean breastfeedingInHealthCenter;

    @Column(name = "baby_breathe_at_birth")
    ...
    public Boolean getBreastfeedingInHealthCenter() {
    ...
    public Boolean getAntiRetroViralTherapyStarted() {
        return isAntiRetroViralTherapyStarted;
    }

    public void setAntiRetroViralTherapyStarted(Boolean antiRetroViralTherapyStarted) {
        isAntiRetroViralTherapyStarted = antiRetroViralTherapyStarted;
    }
