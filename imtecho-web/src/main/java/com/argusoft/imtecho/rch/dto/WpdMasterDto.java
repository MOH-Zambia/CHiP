...
public class WpdMasterDto {
    ...
    private Integer locationHierarchyId;
    ...
    private Boolean isOxytocin;
    private Boolean isIfaGiven;
    private Boolean isMebendazoleGiven;
    ...
    public void setWasARTGiven(Boolean wasARTGiven) {
        this.wasARTGiven = wasARTGiven;
    }

    public Boolean getIsARTGivenDelivery() {
        return isARTGivenDelivery;
    }

    public void setIsARTGivenDelivery(Boolean ARTGivenDelivery) {
        isARTGivenDelivery = ARTGivenDelivery;
    }



    public String getHivDuringDelivery() {
        return hivDuringDelivery;
    }

    public void setHivDuringDelivery(String hivDuringDelivery) {
        this.hivDuringDelivery = hivDuringDelivery;
    }
    public Boolean getIsIfaGiven() {
        return isIfaGiven;
    }

    public void setIsIfaGiven(Boolean ifaGiven) {
        isIfaGiven = ifaGiven;
    }

    public Boolean getIsMebendazoleGiven() {
        return isMebendazoleGiven;
    }

    public void setIsMebendazoleGiven(Boolean mebendazoleGiven) {
        isMebendazoleGiven = mebendazoleGiven;
    }

    public Boolean getIsOxytocin() {
        return isOxytocin;
    }

    public void setISOxytocin(Boolean isOxytocin) {
        this.isOxytocin = isOxytocin;
    }
    ...
    public Integer getLocationHierarchyId() {
        return locationHierarchyId;
    }

    public void setLocationHierarchyId(Integer locationHierarchyId) {
    ...
    public Boolean getBabyBreatheAtBirth() {
        return babyBreatheAtBirth;
    }

    public void setBabyBreatheAtBirth(Boolean babyBreatheAtBirth) {
        this.babyBreatheAtBirth = babyBreatheAtBirth;
    }
    ...
    public boolean isBreastfeedingInHealthCenter() {
        return breastfeedingInHealthCenter;
    }

    public void setBreastfeedingInHealthCenter(boolean breastfeedingInHealthCenter) {
        this.breastfeedingInHealthCenter = breastfeedingInHealthCenter;
    }

    public Date getVitaminK1Date() {
        return vitaminK1Date;
    }

    public void setVitaminK1Date(Date vitaminK1Date) {
        this.vitaminK1Date = vitaminK1Date;
    }
