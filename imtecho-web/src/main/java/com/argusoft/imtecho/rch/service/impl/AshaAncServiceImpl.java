...
import com.argusoft.imtecho.rch.dao.AshaAncMasterDao;
import com.argusoft.imtecho.rch.model.AshaAncMaster;
import com.argusoft.imtecho.rch.service.AshaAncService;
...
public class AshaAncServiceImpl implements AshaAncService {
    ...
    public Integer storeAncServiceVisitForm(ParsedRecordBean parsedRecordBean, Map<String, String> keyAndAnswerMap, UserMaster user) {
        ...
        ashaAncMaster.setLocationHierarchyId(locationLevelHierarchy.getId());
