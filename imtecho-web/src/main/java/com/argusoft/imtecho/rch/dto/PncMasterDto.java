...
public class PncMasterDto {
    ...
    private boolean counselingDone;
    ...
    public boolean getCounselingDone() {
        return counselingDone;
    }

    public void setCounselingDone(boolean counselingDone) {
        this.counselingDone = counselingDone;
    }
