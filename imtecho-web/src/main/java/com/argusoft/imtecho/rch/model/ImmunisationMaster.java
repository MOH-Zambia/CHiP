...
public class ImmunisationMaster extends EntityAuditInfo implements Serializable {
    ...
    private Integer locationHierarcyhId;
    ...
    public ImmunisationMaster(Integer familyId, Integer memberId, String memberType, String visitType, Integer visitId, Integer notificationId, String immunisationGiven, Date givenOn, Integer givenBy, Integer locationId, Integer locationHierarcyhId, Integer pregnancyRegDetId) {
        ...
        this.locationHierarcyhId = locationHierarcyhId;
    ...
    public Integer getLocationHierarcyhId() {
        return locationHierarcyhId;
    }

    public void setLocationHierarcyhId(Integer locationHierarcyhId) {
        this.locationHierarcyhId = locationHierarcyhId;
    }
    ...
    public String toString() {
        return "ImmunisationMaster{" + "id=" + id + ", familyId=" + familyId + ", memberId=" + memberId + ", memberType=" + memberType + ", visitType=" + visitType + ", visitId=" + visitId + ", notificationId=" + notificationId + ", immunisationGiven=" + immunisationGiven + ", givenOn=" + givenOn + ", givenBy=" + givenBy + ", locationId=" + locationId + ", locationHierarcyhId=" + locationHierarcyhId + ", pregnancyRegDetId=" + pregnancyRegDetId + '}';
    }
}
