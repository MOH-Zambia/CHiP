...
public class WpdMotherMaster extends VisitCommonFields implements Serializable {
    ...
    @Column(name="is_oxytocin")
    private Boolean isOxytocin;

    @Column(name="is_IFA_given")
    private Boolean isIfaGiven;

    @Column(name = "other_state_of_delivery")
    private String otherStateOfDelivery;

    public Boolean isOxytocin() {
        return isOxytocin;
    }

    public void setOxytocin(Boolean oxytocin) {
        this.isOxytocin = oxytocin;
    }
    public Boolean isIfaGiven() {
        return isIfaGiven;
    }

    public void setIfaGiven(Boolean ifaGiven) {
        isIfaGiven = ifaGiven;
    }
    ...
    @Column(name = "early_discharge_reason")
    private String earlyDischargeReason;
    @Column(name = "breast_feeding_reason")
    private String noBreastFeedingReason;

    @Column(name = "was_ART_given")
    private Boolean wasARTGiven;

    @Column(name = "hiv_during_delivery")
    ...
    public String getEarlyDischargeReason() {
        return earlyDischargeReason;
    }

    public void setEarlyDischargeReason(String earlyDischargeReason) {
        this.earlyDischargeReason = earlyDischargeReason;
    }

    public String getNoBreastFeedingReason() {
        return noBreastFeedingReason;
    }

    public void setNoBreastFeedingReason(String noBreastFeedingReason) {
        this.noBreastFeedingReason = noBreastFeedingReason;
    }

    public String getOtherStateOfDelivery() {
        return otherStateOfDelivery;
    }
