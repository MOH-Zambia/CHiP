...
import com.argusoft.imtecho.course.dao.CourseMasterDao;
...
import com.argusoft.imtecho.training.dao.TopicCoverageDao;
import com.argusoft.imtecho.training.dao.TrainingDao;
import com.argusoft.imtecho.training.dto.*;
import com.argusoft.imtecho.training.mapper.TopicCoverageMapper;
import com.argusoft.imtecho.training.mapper.TrainingMapper;
import com.argusoft.imtecho.training.model.Attendance;
import com.argusoft.imtecho.training.model.Certificate;
import com.argusoft.imtecho.training.model.TopicCoverage;
import com.argusoft.imtecho.training.model.Training;
import com.argusoft.imtecho.training.service.AttendanceService;
import com.argusoft.imtecho.training.service.CertificateService;
import com.argusoft.imtecho.training.service.TopicCoverageService;
import com.argusoft.imtecho.training.service.TrainingService;
import com.argusoft.imtecho.training.util.TrainingUtil;
import com.argusoft.imtecho.training.util.ValidationUtils;
import com.argusoft.imtecho.training.validation.ValidationResult;
import com.argusoft.imtecho.training.validation.impl.ValidationResultInfo;
...
import static com.argusoft.imtecho.training.util.TrainingUtil.CREATE_VALIDATION;
import static com.argusoft.imtecho.training.util.TrainingUtil.UPDATE_VALIDATION;
...
//            calculating new end as per reschedule training
    ...
    private void calculateNewCompletionDate4Training(Integer trainingId) {
        ...
        Training training = trainingDao.retrieveById(trainingId);
        // converting courseId set into array in order to access course type
        Integer[] courseIds = (Integer[]) training.getTrainingCourseIds().toArray(new Integer[training.getTrainingCourseIds().size()]);
       //setting expiration date only if course is offline
        if(!courseMasterDao.retrieveById(courseIds[0]).getCourseType().toString().equals("ONLINE")) {
