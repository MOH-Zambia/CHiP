 ...
 */
package com.argusoft.imtecho.event.service;

import com.argusoft.imtecho.common.service.EmailService;
...
import com.argusoft.imtecho.event.dto.QueryMasterParamterDto;
...
import com.argusoft.imtecho.notification.service.MobileNotificationHandler;
import com.argusoft.imtecho.query.service.TableService;
import com.argusoft.imtecho.systemfunction.FunctionParametersDto;
        ...
        switch (notificationConfigTypeDto.getType()) {
            case SMS:
                if (notificationConfigTypeDto.getTrigerWhen().equals(EventConfigurationType.TriggerWhen.IMMEDIATELY)) {
                    ...
                    timerEventService.scheduleTimerEvent(new TimerEventDto(null,
                            TimerEvent.TYPE.SMS, trigerOnDate, null, notificationConfigTypeDto.getId(), queryDataLists, null));
                }
                break;
            case EMAIL:
                if (notificationConfigTypeDto.getTrigerWhen().equals(EventConfigurationType.TriggerWhen.IMMEDIATELY)) {
                    ...
                    Date trigerOnDate = getTriggerOnDate(notificationConfigTypeDto);
                    timerEventService.scheduleTimerEvent(new TimerEventDto(null,
                            TimerEvent.TYPE.EMAIL, trigerOnDate, null, notificationConfigTypeDto.getId(), queryDataLists, null));
                }
                break;
            case QUERY:
                if (notificationConfigTypeDto.getTrigerWhen().equals(EventConfigurationType.TriggerWhen.IMMEDIATELY)) {
                    ...
                    Date trigerOnDate = getTriggerOnDate(notificationConfigTypeDto);
                    timerEventService.scheduleTimerEvent(new TimerEventDto(null,
                            TimerEvent.TYPE.QUERY, trigerOnDate, null, notificationConfigTypeDto.getId(), queryDataLists, null));
                }
                break;
            case MOBILE:
            ...
            case PUSH_NOTIFICATION:
                if (notificationConfigTypeDto.getTrigerWhen().equals(EventConfigurationType.TriggerWhen.IMMEDIATELY)) {
                    ...
                    Date trigerOnDate = getTriggerOnDate(notificationConfigTypeDto);
                    timerEventService.scheduleTimerEvent(new TimerEventDto(null,
                            TimerEvent.TYPE.PUSH_NOTIFICATION, trigerOnDate, null, notificationConfigTypeDto.getId(), queryDataLists, null));
                }
                break;
            default:
