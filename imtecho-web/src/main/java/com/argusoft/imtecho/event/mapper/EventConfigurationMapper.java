 ...
 */
package com.argusoft.imtecho.event.mapper;
...
import com.argusoft.imtecho.event.dto.PushNotificationConfigDto;
import com.argusoft.imtecho.event.model.EventConfiguration;
import com.argusoft.imtecho.event.model.EventConfigurationType;
import com.argusoft.imtecho.event.model.MobileEventConfiguration;
...
public class EventConfigurationMapper {
    ...
    public static EventConfigurationType convertToConfigurationTypeMaster(EventConfigTypeDto configTypeDto) throws JsonProcessingException {
        ...
        configurationType.setEventConfigUUID(configTypeDto.getEventConfigUUID());
    ...
    public static EventConfigTypeDto convertToConfigurationTypeDto(EventConfigurationType notificationConfigurationType) {
        ...
        notificationConfigTypeDto.setEventConfigUUID(notificationConfigurationType.getEventConfigUUID());
