 ...
 */
package com.argusoft.imtecho.reportconfig.mapper;
...
import com.argusoft.imtecho.reportconfig.dto.ReportParameterConfigDto;
...
public class ReportMapper {
    ...
    public static ReportConfigDto getReportConfigDto(ReportMaster reportMaster) {
        ...
        if (reportMaster != null) {
            ...
            reportDto.setLastUpdatedOn(reportMaster.getLastUpdatedOn());
            try {
