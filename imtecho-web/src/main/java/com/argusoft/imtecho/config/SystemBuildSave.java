...
public class SystemBuildSave {
    ...
    public void appReady(ApplicationReadyEvent event) {
            try {
                ...
                String mavenVersion = applicationPropertiesBundle.getString("mavenVersion");
                Date buildDate = new SimpleDateFormat("yyyy-MM-dd hh:mm").parse(applicationPropertiesBundle.getString("buildDate"));
