...
import com.argusoft.imtecho.systemconstraint.dao.SystemConstraintFormMasterDao;
...
public class SystemConstraintFormMasterDaoImpl extends GenericDaoImpl<SystemConstraintFormMaster, UUID> implements SystemConstraintFormMasterDao {
    ...
    public String getSystemConstraintConfigsByMenuConfigId(Integer menuConfigId) {
        ...
        queryString
                ...
                .append("       priority\n")
                .append("   from\n")
                .append("       (select prefered_language as lang, 1 as priority from um_user where id = 80206) as preferred_lang\n")
                .append("       union \n")
