...
public class CourseMaster extends EntityAuditInfo implements Serializable {
    ...
    @ElementCollection(fetch = FetchType.EAGER)
    @CollectionTable(name = "tr_course_notification_type_rel", joinColumns = @JoinColumn(name = "course_id"))
    @Column(name = "push_notification_type_id")
    private Set<Integer> pushNotificationTypeIds;

    @ElementCollection(fetch = FetchType.EAGER)
    @CollectionTable(name = "tr_course_notification_type_rel", joinColumns = @JoinColumn(name = "course_id"))
    @Column(name = "id")
    private List<Integer> courseNotificationTypeRelIds;
    ...
    @Column(name = "has_notification_configuration")
    private Boolean hasNotificationConfiguration;
    ...
    public Set<Integer> getPushNotificationTypeIds() {
        return pushNotificationTypeIds;
    }

    public void setPushNotificationTypeIds(Set<Integer> pushNotificationTypeIds) {
        this.pushNotificationTypeIds = pushNotificationTypeIds;
    }

    public Boolean getHasNotificationConfiguration() {
        return hasNotificationConfiguration;
    }

    public void setHasNotificationConfiguration(Boolean hasNotificationConfiguration) {
        this.hasNotificationConfiguration = hasNotificationConfiguration;
    }

    public List<Integer> getCourseNotificationTypeRelIds() {
        return courseNotificationTypeRelIds;
    }

    public void setCourseNotificationTypeRelIds(List<Integer> courseNotificationTypeRelIds) {
        this.courseNotificationTypeRelIds = courseNotificationTypeRelIds;
    }
    ...
    public String toString() {
        return "CourseMaster{" +
                ...
                ", topicIds=" + topicIds +
                ", pushNotificationTypeIds=" + pushNotificationTypeIds +
                ", roleIds=" + roleIds +
                ...
                ", hasNotificationConfiguration=" + hasNotificationConfiguration +
                '}';
    }
