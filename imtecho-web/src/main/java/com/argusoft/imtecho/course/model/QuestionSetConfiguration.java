...
public class QuestionSetConfiguration extends EntityAuditInfo implements Serializable {
    ...
    @Column(name = "is_allowed_to_attempt_quiz_without_completing_lessons")
    private Boolean isAllowedToAttemptQuizWithoutCompletingLessons;
    ...
    public Boolean getIsAllowedToAttemptQuizWithoutCompletingLessons() {
        return isAllowedToAttemptQuizWithoutCompletingLessons;
    }

    public void setIsAllowedToAttemptQuizWithoutCompletingLessons(Boolean allowedToAttemptQuizWithoutCompletingLessons) {
        this.isAllowedToAttemptQuizWithoutCompletingLessons = allowedToAttemptQuizWithoutCompletingLessons;
    }
