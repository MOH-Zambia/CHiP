...
public class LmsUserQuizMetaData {
    ...
    private Integer scoreInFirstAttempt;
    ...
    public Integer getScoreInFirstAttempt() {
        return scoreInFirstAttempt;
    }

    public void setScoreInFirstAttempt(Integer scoreInFirstAttempt) {
        this.scoreInFirstAttempt = scoreInFirstAttempt;
    }
}
