...
public class CourseMasterDto {
    ...
    private Set <PushNotificationDto> pushNotificationDtos;
    ...
    public Set<PushNotificationDto> getPushNotificationDtos() {
        return pushNotificationDtos;
    }

    public void setPushNotificationDtos(Set<PushNotificationDto> pushNotificationDtos) {
        this.pushNotificationDtos = pushNotificationDtos;
    }
