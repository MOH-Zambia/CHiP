...
public class RoleMaster extends EntityAuditInfo implements Serializable {
    ...
    @Column(name = "is_smag_trained_mandatory")
    private Boolean isSmagTrainedMandatory;
    ...
    public Boolean getIsSmagTrainedMandatory() {
        return isSmagTrainedMandatory;
    }

    public void setIsSmagTrainedMandatory(Boolean smagTrainedMandatory) {
        isSmagTrainedMandatory = smagTrainedMandatory;
    }
