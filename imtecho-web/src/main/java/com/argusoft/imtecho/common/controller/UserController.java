...
import com.argusoft.imtecho.common.dto.UserPasswordDto;
...
public class UserController {
    ...
    public List<UserMasterDto> retrieveUsers(
            @RequestParam(name = "username", required = false) Boolean byUsername,
            @RequestParam(name = "contactNumber", required = false) Boolean byContactNumber,
            @RequestParam(name = "name", required = false) Boolean byName,
            @RequestParam(name = "location", required = false) Boolean byLocation,
            @RequestParam(name = "locationId", required = false) Integer locationId,
            @RequestParam(name = "searchString", required = false) String searchString,
    ...
    public String validateAndGenerateOtp(@RequestBody UserPasswordDto userPasswordDto) {
         return userService.validateAndGenerateOtp(userPasswordDto.getUsername());
    }
    ...
    public boolean checkPhone(
        ...
        return userService.checkIfUserExistsWithSamePhone(phoneNumber, userId, null);
    }
