...
public interface UserService {
     ...
     */
    String validateAndGenerateOtp(String username);
     ...
     */
    Boolean checkIfUserExistsWithSamePhone(String contactNumber, Integer userId, Integer roleId);
     ...
     */
    boolean isAnonymous();
    Long getLastLoginDate(Integer userId);
