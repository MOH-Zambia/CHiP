...
public class RoleMapper {
    ...
    public static RoleMasterDto convertRoleMasterToDto(RoleMaster role) {
        ...
        roleDto.setIsSmagTrainedMandatory(role.getIsSmagTrainedMandatory());
        return roleDto;
    }
    ...
    public static RoleMaster convertRoleDtoToMaster(RoleMasterDto roleDto) {
        ...
        role.setIsSmagTrainedMandatory(roleDto.getIsSmagTrainedMandatory() == null ? Boolean.FALSE : roleDto.getIsSmagTrainedMandatory());
        return role;
    }
}
