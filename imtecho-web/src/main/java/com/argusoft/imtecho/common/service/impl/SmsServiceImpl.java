...
import com.argusoft.imtecho.sms_queue.model.SmsQueue;
...
public class SmsServiceImpl implements SmsService {
    ...
    @Autowired
    private SmsTypeMasterDao smsTypeMasterDao;
...
//        List<SmsTypeMasterDto> smsTypeMasterDtos = SmsTypeMapper.entityToDtoList(smsTypeMasters);
//
