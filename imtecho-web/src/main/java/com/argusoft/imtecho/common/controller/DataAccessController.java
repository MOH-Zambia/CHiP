...
public class DataAccessController {
     ...
     * @return ResponseEntity containing a list of InteractionDto objects that match the specified criteria.
     */
    @GetMapping("/getServiceInteractions")
    public ResponseEntity<List<InteractionDto>> getServiceInteractions(
            @RequestParam Integer facilityCode,
