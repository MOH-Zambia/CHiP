 ...
 */
package com.argusoft.imtecho.timer.model;
...
public class TimerEvent implements Serializable {
    ...
    public UUID getEventConfigUUID() {
        return eventConfigUUID;
    }

    public void setEventConfigUUID(UUID eventConfigUUID) {
    ...
    public class TimerEventFields {
        ...
        public static final String EVENT_CONFIG_UUID = "eventConfigUUID";
    }
