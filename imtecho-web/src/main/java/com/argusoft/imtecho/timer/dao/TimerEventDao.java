 ...
 */
package com.argusoft.imtecho.timer.dao;
...
public interface TimerEventDao extends GenericDao<TimerEvent, Integer> {
    ...
    /**
     * Retrieves timer events by event config uuid.
     * @param eventConfigUUID Event config uuid.
     * @return Returns list of timer events by event config uuid.
     */
    List<TimerEvent> retrieveTimerEventsByConfig(UUID eventConfigUUID);
