ALTER TABLE internationalization_label_master DISABLE TRIGGER internationalization_label_master_insert_trigger;
ALTER TABLE internationalization_label_master DISABLE TRIGGER internationalization_label_master_delete;
...
insert into system_constraint_field_master(uuid,form_master_uuid,field_key,field_name,field_type,ng_model,app_name,standard_field_master_uuid,created_by,created_on,modified_by,modified_on)
                         values(cast('f807fabb-8571-4e31-b131-0f29eea0b2d1' as uuid),cast('808a9e11-7f8c-4ef8-b61f-834220a1755b' as uuid),'locationHierarchy','locationHierarchy','INFORMATION_DISPLAY','memberDetails','WEB',null,60512,now(),97084,now());

insert into system_constraint_field_master(uuid,form_master_uuid,field_key,field_name,field_type,ng_model,app_name,standard_field_master_uuid,created_by,created_on,modified_by,modified_on)
                         values(cast('7064db52-6ac6-4732-9157-3a26da4787ec' as uuid),cast('808a9e11-7f8c-4ef8-b61f-834220a1755b' as uuid),'caste','caste','INFORMATION_DISPLAY','memberDetails','WEB',null,60512,now(),97084,now());
...
insert into system_constraint_field_master(uuid,form_master_uuid,field_key,field_name,field_type,ng_model,app_name,standard_field_master_uuid,created_by,created_on,modified_by,modified_on)
                         values(cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),cast('808a9e11-7f8c-4ef8-b61f-834220a1755b' as uuid),'serviceDate','serviceDate','DATE','formData','WEB',null,97084,now(),97084,now());

delete from internationalization_label_master where key = 'serviceDate_RCH_FACILITY_ANC' and app_name in ('WEB');
delete from internationalization_label_master where key = 'serviceDate_RCH_FACILITY_ANC' and app_name in ('TECHO_MOBILE_APP');

insert into internationalization_label_master(country,key,language,created_by,created_on,custom3b,text,translation_pending,modified_on,app_name)
                                values('IN','serviceDate_RCH_FACILITY_ANC','EN','-1',now(),false,'Service Date',false,now(),'TECHO_MOBILE_APP');
...
insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('b5596924-a8f1-4831-a38e-924057dbf93e' as uuid),cast('7064db52-6ac6-4732-9157-3a26da4787ec' as uuid),'REQUIRABLE','requirable',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('0fcbe37b-8c6e-45d1-a1ff-c211051c9d9c' as uuid),cast('7064db52-6ac6-4732-9157-3a26da4787ec' as uuid),'EVENTS','events',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('12256bf2-cd79-4373-9f39-f7c5365512fd' as uuid),cast('7064db52-6ac6-4732-9157-3a26da4787ec' as uuid),'DROPDOWN','displayType',null,'text',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('21e7667a-d8c2-4b86-bb08-8effcb3f2126' as uuid),cast('7064db52-6ac6-4732-9157-3a26da4787ec' as uuid),'VISIBILITY','visibility',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('5ad7525a-f1ed-43c1-abdf-154bc9b87d00' as uuid),cast('7064db52-6ac6-4732-9157-3a26da4787ec' as uuid),'DISABILITY','disability',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('794c7ee5-3f85-4d36-889e-9b047ccf8b1e' as uuid),cast('7064db52-6ac6-4732-9157-3a26da4787ec' as uuid),'TEXT','displayValue',null,'Caste',60512,now(),97084,now());
...
insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('a7c990ae-d1c8-448c-be25-f513d71ef966' as uuid),cast('f807fabb-8571-4e31-b131-0f29eea0b2d1' as uuid),'DROPDOWN','displayType',null,'text',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('23ab5062-91c0-41f7-a432-998ea4740784' as uuid),cast('f807fabb-8571-4e31-b131-0f29eea0b2d1' as uuid),'VISIBILITY','visibility',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('24b1840f-4155-45d9-8075-a23cea55064c' as uuid),cast('f807fabb-8571-4e31-b131-0f29eea0b2d1' as uuid),'REQUIRABLE','requirable',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('41d025b2-e16e-4e8b-a596-5f13c862e117' as uuid),cast('f807fabb-8571-4e31-b131-0f29eea0b2d1' as uuid),'TEXT','displayValue',null,'Location Hierarchy',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('5fc426fb-1fe4-4914-8837-58fa2695b054' as uuid),cast('f807fabb-8571-4e31-b131-0f29eea0b2d1' as uuid),'EVENTS','events',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('7ee17d76-5567-4ecd-ace7-529543812304' as uuid),cast('f807fabb-8571-4e31-b131-0f29eea0b2d1' as uuid),'DISABILITY','disability',null,'null',60512,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('326127b3-05cf-4c7d-b7cd-c857a7bed0b0' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'REQUIRABLE','requirable',null,'null',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('a00ea117-9bc2-4075-9002-c90966f9ab4f' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'DISABILITY','disability',null,'null',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('dfc42c6e-5e79-4ce6-8725-bfcb5b526c6c' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'TEXT','maxDateField',null,'maxServiceDate',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('fbfb0bbb-a43e-4b85-a643-26d87e17cdd1' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'EVENTS','events',null,'[{"0":{"type":"","value":""},"$$hashKey":"object:1302","type":"Change","value":"serviceDateChanged"}]',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('4a3a3ac1-61c6-4ec8-afa7-9a5b7704b764' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'TEXT','placeholder',null,'Service Date',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('5c8f1a11-4522-41f4-a78d-484da71a82c8' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'TEXT','label',null,'serviceDate_RCH_FACILITY_ANC',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('62dd54df-c5f8-45ea-951b-9a7ebdf97f22' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'BOOLEAN','isHidden',null,'false',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('9326a181-688e-4393-a5f8-fdac02a291a2' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'TEXT','minDateField',null,'minServiceDate',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('95dd36d5-0867-45b8-a70c-39713284480f' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'BOOLEAN','isDisabled',null,'false',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('98803f2a-b804-4fb9-8ba6-2ac6219fb897' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'VISIBILITY','visibility',null,'null',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('b77b8723-ee0a-41f7-8043-4fbf35368f80' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'TEXT','tooltip',null,'Service Date',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('d1c2f180-1363-41c1-a041-492e6f03797f' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'TEXT','requiredMessage',null,'Please select service date',97084,now(),97084,now());

insert into system_constraint_field_value_master(uuid,field_master_uuid,value_type,key,value,default_value,created_by,created_on,modified_by,modified_on)
                         values(cast('e52ba7aa-693a-4740-9f38-4838fa399089' as uuid),cast('3228dea8-a660-4d58-8131-628f9fff37ff' as uuid),'BOOLEAN','isRequired',null,'true',97084,now(),97084,now());


ALTER TABLE internationalization_label_master ENABLE TRIGGER internationalization_label_master_insert_trigger;
ALTER TABLE internationalization_label_master ENABLE TRIGGER internationalization_label_master_delete;