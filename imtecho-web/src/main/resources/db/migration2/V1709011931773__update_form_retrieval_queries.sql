...
VALUES(nextval('menu_config_id_seq'::regclass), '{}', NULL, true, false, 'Zonal Collation Form Search', 'techo.manage.zonalcollationformsearch', NULL, 'manage', false, NULL, NULL, NULL, NULL, '');

--update for existing queries--

--retrieve_zcf_user_details

DELETE FROM QUERY_MASTER WHERE CODE='retrieve_zcf_user_details';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state ) 
VALUES ( 
'd7619120-dbff-496f-a7a8-b781759bbc24', 97074,  current_date , 97074,  current_date , 'retrieve_zcf_user_details', 
 null, 
'select
...
'For fetching user details in Zonal Collation Form', 
true, 'ACTIVE');
