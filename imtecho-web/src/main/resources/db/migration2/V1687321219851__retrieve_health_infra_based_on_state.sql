DELETE FROM QUERY_MASTER WHERE CODE='health_infrastructure_retrieval_state_based';

INSERT INTO QUERY_MASTER (uuid, created_by, created_on, modified_by, modified_on, code, params, query, description, returns_result_set, state ) 
VALUES ( 
'7f352f6f-280b-4c01-8adc-e1df8e6e8d89', 74724,  current_date , 74724,  current_date , 'health_infrastructure_retrieval_state_based', 
'offset,locationId,name,limit,state,type', 
...
'retrieve health infrastructure based on state', 
true, 'ACTIVE');