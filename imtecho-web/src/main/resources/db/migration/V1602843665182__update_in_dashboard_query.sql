update
	menu_config
set
	menu_name = 'District Performance Dashboard'
where
	menu_name = 'Distinct Performance Dashboard';

DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_pw_reg integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_pw_reg> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_inst_del integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_inst_del> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_phi_del integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_phi_del> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_home_del integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_home_del> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_cortico_steroid integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_cortico_steroid> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_child_reg integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_child_reg> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_weighed integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_weighed> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_lbw integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_lbw> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_ppiucd integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_ppiucd> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_anemic_pw integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_anemic_pw> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_severe_anemic_treated integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_severe_anemic_treated> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_anc4 integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_anc4> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_c_section_delivery integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_c_section_delivery> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
