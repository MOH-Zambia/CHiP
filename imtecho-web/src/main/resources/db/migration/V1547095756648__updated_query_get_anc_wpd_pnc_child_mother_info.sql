...
insert into query_master(created_by,created_on,code,params,query,returns_result_set,state,description)
values(1,now(),'retrieve_rch_child_service_master_info','healthid','select csm.id as "csmId",csm.member_id as "memberId",csm.family_id as "csmFamilyId",csm.latitude,csm.longitude,csm.mobile_start_date as "mobileStartDate",
