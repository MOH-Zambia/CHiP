--- https://argusgit.argusoft.com/mhealth-projects/imtecho/issues/3242

update query_master
set params = 'member_id,location_hierarchy_id,action_by,family_id,service_type,reference_id,death_reason,other_death_reason,place_of_death,location_id,death_date,health_infra_id,member_death_mark_state',
modified_on = now(),
