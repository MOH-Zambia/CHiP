...
DROP COLUMN IF EXISTS chart_order;

ALTER TABLE soh_chart_configuration ADD COLUMN chart_order SMALLINT;
...
(74909,'2020-04-13 00:00:00.000',80208,'2020-04-14 18:18:38.894','covid19_fetch_patients_admitted_more_than_15_days','days','select
member_det as "name",
age as "age",
