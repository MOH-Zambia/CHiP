...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_child_screening_for_malnutritition integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_child_screening_for_malnutritition> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN per_sam float;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <per_sam> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN total_sam_rank integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <total_sam_rank> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_sam integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_sam> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
...
DO $$ 
    BEGIN
        BEGIN
            ALTER TABLE rch_dashboard_analytics ADD COLUMN expected_total_anemic integer;
        EXCEPTION
            WHEN duplicate_column THEN RAISE NOTICE 'column <expected_total_anemic> already exists in <rch_dashboard_analytics>.';
        END;
    END;
$$;
