...
values(1, current_date, 'ncd_diabetes_treatment_history', 'memberId', '
...
inner join ncd_member_referral on ncd_member_diabetes_detail.referral_id = ncd_member_referral.id
...
', true, 'ACTIVE', 'To retrieve diabetes disease treatment history of patient.');