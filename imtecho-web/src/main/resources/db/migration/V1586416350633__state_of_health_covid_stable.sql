...
case when m.gender = ''F'' then ''Female'' else ''Male'' end as "primaryVal_Gender",
...
and positive_member = 1 and discharge_date is null and health_state in(''Stable'',''Stable-Moderate'')
