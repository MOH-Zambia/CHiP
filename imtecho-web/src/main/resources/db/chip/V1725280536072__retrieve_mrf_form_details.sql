INSERT INTO query_master (created_by,created_on,modified_by,modified_on,code,params,query,returns_result_set,state,description,is_public,uuid) VALUES
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_tb_details',NULL,'select
...
and created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'9eed98e0-f0d6-4f7f-9d5d-4944288afaa3'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_malaria_details',NULL,'select
	count(*) as chw5_01,
...
where date(created_on) >= date(:month)
and created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'b2683e70-01ed-42dc-b6ca-d1cd634d14e7'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_hiv_details',NULL,'select
...
and rhsm.created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'62e1ac8c-8106-428a-b32e-2d67794a0663'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_pregnancy_details',NULL,'select
...
and state != ''MARK_AS_WRONGLY_PREGNANT'';',true,'ACTIVE','Used for Forms',true,'f1f66b3e-60f2-4c91-adfb-3f246cd5353b'),
	 (60512,'2024-02-14 00:00:00.000',60512,'2024-02-14 00:00:00.000','retrieve_mrf_user_details',NULL,'select
...
inner join location_master lm on lm.id = uul.loc_id;',true,'ACTIVE','Used for Monthly Reporting Form',true,'b8608eff-0dad-41d8-9a05-fe5940a6251b'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_family_details',NULL,'select
	count(*) as chw1_01,
	count(*) as chw1_03,
...
from imt_family
where date(created_on) >= date(:month)
and created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'0266ede1-e1c3-4ef1-a0a1-11c24f12de0c'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_member_details',NULL,'select
...
and im.created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'61d9d1e8-e546-46a0-8591-adb4728797a6'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_anc_details',NULL,'with multiple_visits as (
	select
...
where ram.created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'39fc2b6a-ab20-49ba-865b-b8a38c82ae63'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_wpd_details',NULL,'select
...
and rwmm.created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'424a894e-c654-4a7a-b3a9-56b1b7265925'),
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_pnc_details',NULL,'select
...
and rpm.created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'9c8f94db-bcd8-45da-8db1-ca754ca90ec8');
INSERT INTO query_master (created_by,created_on,modified_by,modified_on,code,params,query,returns_result_set,state,description,is_public,uuid) VALUES
	 (60512,'2024-02-27 00:00:00.000',60512,'2024-02-27 00:00:00.000','retrieve_mrf_csv_details',NULL,'select
...
and rcsm.created_by = cast(:userId as integer);',true,'ACTIVE','Used for Forms',true,'7b7c0218-6a89-4c38-8bd8-f20339aa4702');
