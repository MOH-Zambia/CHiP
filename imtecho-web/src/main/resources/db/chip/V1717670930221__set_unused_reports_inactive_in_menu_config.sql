...
where menu_name in(
    'Adolescent Report',
	'State Of Health - Elements',
	'GVK Service Verification calls',
	'Real Time Data Entry Analysis',
	'Login Rate(Location-wise)',
	'NCD Form Fillup (Location wise)',
	'Maternal Health Services provided to the mother registered during the year',
	'Pregnant females registered during the year in the ''Age Group''',
	'Infrastructure Wise Component Availability',
	'Health infra detail (Developer)',
	'Lab wise Sample Status',
	'Lab sample status(Location-wise)',
	'Facility Status Report',
	'Active patients current (Facility Status Report)',
	'Positive (Lab Sample Status Location-Wise)',
	'test report 1',
    'User count',
    ...
    'Status of HIV Testing in Pregnant Women Report',
