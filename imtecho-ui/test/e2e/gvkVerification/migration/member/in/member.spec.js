...
describe('Member Migration Out', () => {
    ...
    it('GVK Verification -> MMI -> 6 -> Member Migration In with Search For Member with Location 006', async function () {
        console.log('\nMember Migration In with Search For Member with Location 006');
