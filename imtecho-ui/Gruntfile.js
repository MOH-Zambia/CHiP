...
module.exports = function (grunt) {
    ...
    grunt.registerTask('dnhdd', ['ngconstant:dnhdd'])

    grunt.registerTask('chip', ['ngconstant:chip'])

    grunt.registerTask('imomcare', ['ngconstant:imomcare'])
