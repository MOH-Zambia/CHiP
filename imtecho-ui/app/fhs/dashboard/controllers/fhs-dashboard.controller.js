...
//         ctrl.getFamiliesAndMembers = function (locationId, nameOfLocation, locationType) {
...
//                     };
//                     if (ctrl.env === 'dnhdd') {
//                         delete excelObj["Imported From eMamta"];
//                         delete excelObj["Imported eMamta Member"];
//                     }
...
//                 }
//                 if (ctrl.env === 'dnhdd') {
//                     ctrl.bars = [ctrl.barVerified, ctrl.barArchieved, ctrl.barUnverified, ctrl.barNewFamiliesAdded];
//                 } else {
...
//             if (!ctrl.selectedLocation.finalSelected.optionSelected && ctrl.selectedLocation.finalSelected.level === 1) {
//                 return;
//             }
//             ctrl.familiesAndMembers = [];
//             let level = 1;
...
//                     level++;
//                 }
//                 ctrl.getFamiliesAndMembers(selectedobj.locationId, selectedobj.name, selectedobj.type);
//                 ctrl.toggleFilter();
//             }
//         };
