...
//         const ESTIMATED_FAMILIES = "ESTIMATED_FAMILIES";
//         const ESTIMATED_POPULATION = "ESTIMATED_POPULATION";
...
//         ctrl.saveEstimatedFamilies = () => {
//             if (ctrl.isFormValid(ESTIMATED_FAMILIES)) {
//                 if (ctrl.totalMatched(ESTIMATED_FAMILIES)) {
//                     let expectedTargetDtos = [];
//                     ctrl.locationList.forEach(location => {
//                         expectedTargetDtos.push({
//                             locationId: location.id,
//                             financialYear: ctrl.expectedTargetDto.financialYear,
//                             Expected_Family: location.Expected_Family,
//                             state: ctrl.draftState
//                         });
//                     });
//                     ctrl.saveExpectedTarget(expectedTargetDtos);
...
//         ctrl.saveEstimatedPopulation = () => {
//             if (ctrl.isFormValid(ESTIMATED_POPULATION)) {
//                 if (ctrl.totalMatched(ESTIMATED_POPULATION)) {
//                     let expectedTargetDtos = [];
//                     ctrl.locationList.forEach(location => {
//                         expectedTargetDtos.push({
//                             locationId: location.id,
//                             financialYear: ctrl.expectedTargetDto.financialYear,
//                             Expected_Population: location.Expected_Population,
//                             state: ctrl.draftState
//                         });
//                     });
//                     ctrl.saveExpectedTarget(expectedTargetDtos);
...
//             if ((ctrl.env != 'dnhdd' && ctrl.isFormValid(MOTHER_REGISTERED) && ctrl.isFormValid(DELIVERY_REGISTERED) && ctrl.isFormValid(VACCINATION_1) && ctrl.isFormValid(VACCINATION_2)) 
//                 || (ctrl.env === 'dnhdd' && ctrl.isFormValid(ESTIMATED_FAMILIES) && ctrl.isFormValid(ESTIMATED_POPULATION))) {
//                 if ((ctrl.env != 'dnhdd' && ctrl.totalMatched(MOTHER_REGISTERED) && ctrl.totalMatched(DELIVERY_REGISTERED) && ctrl.totalMatched(VACCINATION_1) && ctrl.totalMatched(VACCINATION_2))
//                     || (ctrl.env === 'dnhdd' && ctrl.totalMatched(ESTIMATED_FAMILIES) && ctrl.totalMatched(ESTIMATED_POPULATION))) {
//                     let expectedTargetDtos = [];
//                     ctrl.locationList.forEach(location => {
//                         expectedTargetDtos.push({
//                             locationId: location.id,
...
//                     Expected_Family: ctrl.currentLocation.Expected_Family,
//                     Expected_Population: ctrl.currentLocation.Expected_Population,
//                     state
//                 });
//                 Mask.show();
//                 ExpectedTargetDAO.createOrUpdate(expectedTargetDtos).then(() => {
...
//                         Expected_Family: responses[2].Expected_Family || 0,
//                         Expected_Population: responses[2].Expected_Population || 0
//                     });
...
//                                 location.Expected_Family = ctrl.expectedTarget.Expected_Family || 0;
//                                 location.Expected_Population = ctrl.expectedTarget.Expected_Population || 0;
//                             } else {
...
//                                 location.Expected_Family = 0;
//                                 location.Expected_Population = 0;
//                             }
//                         });
...
//                     });
//                     break;
//                 case ESTIMATED_FAMILIES:
//                     ctrl.total.estimatedFamilies = 0;
//                     ctrl.locationList.forEach(location => {
//                         if (location.Expected_Family != null) {
//                             ctrl.total.estimatedFamilies += location.Expected_Family;
//                             ctrl.difference.estimatedFamilies = ctrl.currentLocation.Expected_Family - ctrl.total.estimatedFamilies;
//                         }
//                     });
//                     break;
//                 case ESTIMATED_POPULATION:
//                     ctrl.total.estimatedPopulation = 0;
//                     ctrl.locationList.forEach(location => {
//                         if (location.Expected_Population != null) {
//                             ctrl.total.estimatedPopulation += location.Expected_Population;
//                             ctrl.difference.estimatedPopulation = ctrl.currentLocation.Expected_Population - ctrl.total.estimatedPopulation;
//                         }
//                     });
//                     break;
//             }
...
//                 case ESTIMATED_FAMILIES:
//                     return ctrl.total.estimatedFamilies === ctrl.currentLocation.Expected_Family;
//                 case ESTIMATED_POPULATION:
//                     return ctrl.total.estimatedPopulation === ctrl.currentLocation.Expected_Population;  
//             }
//         }
...
//             ctrl.calculateTotal(ESTIMATED_FAMILIES);
//             ctrl.calculateTotal(ESTIMATED_POPULATION);
//         }
...
//                 ...(ctrl.env === 'dnhdd') 
//                 && {
//                     "Estimated Families": "Financial Year",
...
//                 ...(ctrl.env === 'dnhdd') 
//                 && {
//                     "Estimated Families": ctrl.expectedTargetDto.financialYear,
//                     "Estimated Population": ""
//                    }
//             }, {
//                 "Location Name": "",
...
//                 ...(ctrl.env === 'dnhdd') 
//                 && {
//                     "Estimated Families": "Estimated Families",
...
//                     ...(ctrl.env === 'dnhdd') 
//                     && {
//                         "Estimated Families": ctrl.locationList[index].Expected_Family,
//                         "Estimated Population": ctrl.locationList[index].Expected_Population
//                        }
//                 }
...
//                 ...(ctrl.env === 'dnhdd') 
//                 && {
//                     "Estimated Families": ctrl.total.estimatedFamilies,
//                     "Estimated Population": ctrl.total.estimatedPopulation
//                    }
//             });
//             let mystyle = {
//                 headers: false,
