(function (angular) {
    const UpdateHealthInfraMappingeModalController = function ($rootScope, Mask, GeneralUtil, QueryDAO, toaster, $state, $q, $uibModalInstance, mapping) {
        const ctrl = this;
            ...
            if (ctrl.mappingInfraForm.$valid) {
                ...
                let queryDto = {
                    ...
                    parameters: {
                        ...
                        allowedFacilities: ctrl.mapping?.allowedFacilities ? ctrl.mapping.allowedFacilities.join() : null
                    }
                };
