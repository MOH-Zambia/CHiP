// (function () {
//     function WebTasksController(WebTasksService, PagingService, AuthenticateService, $state, Mask, toaster, $uibModal, $sessionStorage, GeneralUtil, QueryDAO,ENV) {
//         var webtasks = this;
...
//                     Mask.hide();
//                 });
//                 if(ENV.implementation !== 'imomcare')
//                     webtasks.retrievePreferenceByUserId();
//                 else 
//                     {
//                         webtasks.showButtons = true;
//                         webtasks.formArray.push(
//                             {
//                                 icon : 'fa-solid fa-people-roof',
//                                 title : 'Family Planning Service Visit',
//                                 state : 'ACTIVE',
//                                 route : 'techo.manage.fpChangeSearch',
//                                 color: '#e0691a'
//                             },
//                             {
//                                 icon : 'fa fa-light fa-person-pregnant',
//                                 title : 'ANC Service Visit',
//                                 state : 'ACTIVE',
//                                 route : 'techo.manage.ancSearch',
//                                 color: '#e1a'
//                             },
//                             {
//                                 icon : 'fa-solid fa-house-medical fa-1x',
//                                 title : 'Delivery Reg. Form',
//                                 state : 'ACTIVE',
//                                 route : 'techo.manage.wpdSearch',
//                                 color: '#ffc107'
//                             },
//                             {
//                                 icon : 'fa fa-light fa-person-breastfeeding',
//                                 title : 'PNC Service Visit',
//                                 state : 'ACTIVE',
//                                 route : 'techo.manage.pncSearch',
//                                 color: '#28a745'
//                             },
//                             {
//                                 icon : 'fa-solid fa-people-roof',
...
//                                 state : 'ACTIVE',
//                                 route :'techo.manage.childServiceSearch',
//                                 color: '#007bff'
//                             }
//                         )
//                     }
...
//                 }
//                 WebTasksService.getNotificationActions(webtasks.currentBasket.id).then(function (response) {
//                     Mask.hide();
//                     webtasks.actionOptionsForSelectedTask = response;
//                 }, function (error) {
//                     Mask.hide();
//                     toaster.pop('error', 'Unable to retrieve task details');
//                 });
