(function () {
    function HouseholdDashboardController(QueryDAO, Mask, GeneralUtil,AuthenticateService) {
        ...
        ctrl.setBarChart = (barResult) => {
            ...
            ctrl.barChartSeries = ['Household facilities availability'];
            ctrl.barChartColors = [
              {
        ...
        ctrl.tableCount = () => {
            ...
            QueryDAO.executeQuery(tableQueryDto).then(function (res) {
                ctrl.houseHoldTableData = res.result;
            }, GeneralUtil.showMessageOnApiCallFailure).finally(function () {
                Mask.hide();
            })
        }
    ...
    angular.module('imtecho.controllers').controller('HouseholdDashboardController', HouseholdDashboardController);
})();
