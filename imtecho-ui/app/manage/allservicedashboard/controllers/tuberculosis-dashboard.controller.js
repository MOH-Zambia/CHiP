(function () {
    function TuberculosisDashboardController($scope,QueryDAO,GeneralUtil,Mask,AuthenticateService) {
        let ctrl = this;
        ...
        ctrl.chartCount = () =>
            {
                let pieQueryDto = {
                    code: 'fetch_tuberculosis_pie_chart_data',
                    parameters: {
                        location_id: ctrl.selectedLocationId   
                    }
                };
                ...
                let barQueryDto = {
                    code: 'fetch_tuberculosis_bar_chart_data',
                    parameters: {
                        location_id: ctrl.selectedLocationId   
                    }
                };
                ctrl.barChartSeries = ['Tuberculosis count']
            ctrl.barChartColors = [{
        ...
        ctrl.setBarChart = (barResult) => {
            ...
            ctrl.tableCount = () =>
                {
                    let tableQueryDto = {
                        code: 'fetch_tuberculosis_table_data',
                        parameters: {
                            location_id: ctrl.selectedLocationId   
                        }
                    };
                    ...
                    QueryDAO.executeQuery(tableQueryDto).then(function (res) {
                        ctrl.tuberculosisTableData = res.result;
                    }, GeneralUtil.showMessageOnApiCallFailure).finally(function () {
                        Mask.hide();
                    })
                }
    ...
    angular.module('imtecho.controllers').controller('TuberculosisDashboardController', TuberculosisDashboardController);
})();
