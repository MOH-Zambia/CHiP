(function () {
    function MalariaDashboardController(QueryDAO,GeneralUtil,Mask,AuthenticateService) {
        ...
        ctrl.setBarChart = (barResult) => {
            ...
            ctrl.barChartSeries = ['Malaria counts']
            ctrl.barChartColors = [{
            ...
            ctrl.tableCount = () =>
                {
                    ...
                    QueryDAO.executeQuery(tableQueryDto).then(function (res) {
                        ctrl.malariaTableData = res.result;
                    }, GeneralUtil.showMessageOnApiCallFailure).finally(function () {
                        Mask.hide();
                    })
                }
    ...
    angular.module('imtecho.controllers').controller('MalariaDashboardController', MalariaDashboardController);
})();
