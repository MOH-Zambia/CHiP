(function () {
    function ZonalCollationFormSearch(Mask, GeneralUtil, $state, SEARCH_TERM, UserDAO, PagingService) {
        let ctrl = this;
        ...
        ctrl.previewClicked=function(data){
            $state.go('techo.manage.zonalcollationform',{"id":data})
        }
      
      
        ctrl.init();
    }
    angular.module('imtecho.controllers').controller('ZonalCollationFormSearch', ZonalCollationFormSearch);
})();