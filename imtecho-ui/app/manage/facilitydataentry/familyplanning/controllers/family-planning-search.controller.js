...
//         fpchangesearch.env = GeneralUtil.getEnv();
...
//                 fpchangesearch.memberDetails = [];
//             }
//             if ((fpchangesearch.search.searchBy === 'village name' || fpchangesearch.search.searchBy === 'location') && fpchangesearch.selectedLocationId == null) {
...
//                     search.byOrganizationUnit = ((fpchangesearch.search.searchBy === 'location' || fpchangesearch.search.searchBy === 'village name') && fpchangesearch.search.searchString !== '') ? true : false;
