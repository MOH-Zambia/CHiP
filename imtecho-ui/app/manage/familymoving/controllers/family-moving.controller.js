...
//                     !(fm.selectedLocation.finalSelected.level == fm.fetchUptoLevel - 1 || fm.selectedLocation.finalSelected.level == fm.fetchUptoLevel)) {
//                     return;
//                 } else {
...
//                                     } else {
//                                         _.each(familyByLocationIdAnganwadiService.members, function (member) {
...
//             if (fm.isVerifiedFamily && fm.selectedMoveLocation.finalSelected.level === fm.fetchUptoLevel - 1) {
//                 if (fm.env === 'dnhdd') {
//                     toaster.pop("warning", fm.selectedMoveLocation.level5.name + " is not proper Location to move family");
//                 } else {
...
//                 if (fm.selectedMoveLocation.finalSelected.level === fm.fetchUptoLevel - 1) {
