        ...
        var api = $resource(APP_CONFIG.apiPath + '/report/:action/:subaction', {},
            {
                ...
                retriveSummaryOfAReport:{
                    method:'POST',
                    params:{
                        action:'retrivesummaryforareport',
                        subaction:'@uuid'
                    }
                }
        ...
        return {
            ...
            getDynamicDetail: function (id, type) {
                if (type == 'code') {
                    ...
                    return api.get({ action: 'dynamicdetail', uuid: id, fetchQueryOptions: true }).$promise;
                }
            },
            ...
            generateSummary:function(uuid,filterObject){
                
                return api.retriveSummaryOfAReport({subaction:uuid},filterObject).$promise
            }
