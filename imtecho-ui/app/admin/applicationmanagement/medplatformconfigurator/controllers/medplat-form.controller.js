(function () {
    function MedplatForm($state, Mask, toaster, GeneralUtil, $q, QueryDAO, MedplatFormService, $uibModal) {
        let ctrl = this;
        ...
        ctrl.fieldTypes = [{
            ...
            key: 'IMMUNISATION_DIRECTIVE',
            value: 'Immunisation Directive (WEB)'
        }, {
            key: 'ADDED_LOCATIONS',
        ...
        ctrl.onlyWebFields = ["PASSWORD", "LOCATION_DIRECTIVE", "ADDED_LOCATIONS", "CUSTOM_HTML", "CUSTOM_COMPONENT", "TABLE", "BUTTON", "FILE_UPLOAD", "INFORMATION_TEXT", 'IMMUNISATION_DIRECTIVE'];
        ...
        ctrl.getSystemConstraintFormConfig = function () {
            ...
            promises.push(MedplatFormService.getSystemConstraintStandardFields(true));
            if (ctrl.editMode) {
                promises.push(MedplatFormService.getSystemConstraintFormConfigByUuid(ctrl.systemConstraintFormUuid));
            }
            Mask.show();
        ...
        ctrl.getSystemConstraintFormConfigByUuid = function () {
            Mask.show();
            MedplatFormService.getSystemConstraintFormConfigByUuid(ctrl.systemConstraintFormUuid).then(response => {
        ...
        ctrl.getSystemConstraintFormsByMenuConfigId = function () {
            ...
            promises.push(QueryDAO.executeAll(dtoList));
            promises.push(MedplatFormService.getSystemConstraintStandardFields(true));
            promises.push(MedplatFormService.getSystemConstraintFormsByMenuConfigId(ctrl.menuConfigId));
            Mask.show();
            $q.all(promises).then(responses => {
                ctrl.menuItems = responses[0][0].result;
                ctrl.SystemConstraintStandardFields = responses[1];
        ...
        ctrl.onFeatureMenuSelection = function () {
            ...
            Mask.show();
            MedplatFormService.getSystemConstraintFormsByMenuConfigId(ctrl.menuConfigId).then(response => {
        ...
        ctrl.saveFormConfig = function () {
            ...
            if (ctrl.manageSystemConstraintForm.$valid) {
                Mask.show();
                MedplatFormService.createOrUpdateSystemConstraintForm(ctrl.systemConstraintFormConfig.systemConstraintFormMasterDto, 'ALL').then(response => {
        ...
        ctrl.saveFieldConfig = function (index, fieldConfig) {
            ...
            if (ctrl.manageSystemConstraintField.$valid) {
                ...
                MedplatFormService.createOrUpdateSystemConstraintFieldConfig(ctrl.systemConstraintFormConfig.systemConstraintFormMasterDto.uuid, fieldConfig).then(response => {
        ...
        ctrl.removeFieldConfig = function (index, fieldConfigUuid) {
            ...
            Mask.show();
            MedplatFormService.deleteSystemConstraintFieldConfig(fieldConfigUuid).then(() => {
                ctrl.systemConstraintFormConfig.systemConstraintFieldMasterDtos.splice(index, 1);
        ...
        ctrl.defineFunctionCode = (fieldConfig, index) => {
            let currentCodeEditorModel = null;
            let currentEvent = fieldConfig.events[index];
            let functionName = currentEvent.value;
            if (currentEvent.code != null) {
                currentCodeEditorModel = currentEvent.code;
            } else {
                currentCodeEditorModel = `(function ${functionName}(){\n\n});`;
            }
            ...
            modalInstance.result.then(function (data) {
                fieldConfig.events[index].code = data.code;
            }, () => {
            });
        }
        ...
        ctrl.configureFormObject = () => {
            let modalInstance = $uibModal.open({
                ...
                resolve: {
                    config: () => {
                        return {
                            formObject: JSON.parse(ctrl.systemConstraintFormConfig.systemConstraintFormMasterDto.formObject || null)
                        }
                    }
                }
            });
            modalInstance.result.then(function (data) {
                ctrl.systemConstraintFormConfig.systemConstraintFormMasterDto.formObject = data.formObject;
            }, () => {
            });
        }
        ...
        ctrl.configureFormVMs = () => {
            let modalInstance = $uibModal.open({
                ...
                resolve: {
                    config: () => {
                        return {
                            formVm: JSON.parse(ctrl.systemConstraintFormConfig.systemConstraintFormMasterDto.formVm || null)
                        }
                    }
                }
            });
            modalInstance.result.then(function (data) {
                ctrl.systemConstraintFormConfig.systemConstraintFormMasterDto.formVm = data.formVm;
            }, () => {
            });
        }
    ...
    angular.module('imtecho.controllers').controller('MedplatForm', MedplatForm);
})();