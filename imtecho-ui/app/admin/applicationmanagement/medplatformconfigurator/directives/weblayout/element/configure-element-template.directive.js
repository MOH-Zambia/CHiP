(function () {
    let configureElementTemplateDirective = function ($uibModal) {
        return {
            ...
            templateUrl: 'app/admin/applicationmanagement/medplatformconfigurator/directives/weblayout/element/configure-element-template.html',
            link: function (scope) {
                ...
                scope.onRemoveWebComponent = function () {
                    ...
                    let field = scope.fields.find((f) => {
                        return f.config.fieldKey === scope.element.config.fieldKey && f.config.fieldType === scope.element.config.fieldType
                    });
                ...
                scope.manageFieldConfig = function (config) {
                    let modalInstance = $uibModal.open({
                        templateUrl: 'app/admin/applicationmanagement/medplatformconfigurator/directives/weblayout/element/configure-element-template-config.modal.html',
