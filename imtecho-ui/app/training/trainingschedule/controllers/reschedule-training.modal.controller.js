(function (angular) {
    var RescheduleModalController = function ($uibModalInstance, $filter, training, toaster, GeneralUtil, Mask, CommonService, TrainingService, TopicCoverageService) {
        var $ctrl = this;
        $ctrl.rescheduleTrainingId = angular.copy(training[0]);
        $ctrl.courseType = training[1];
        ...
        TopicCoverageService.getTopicCoverageByTrainingId(training[0]).then(function (response) {
            var topics = response;
