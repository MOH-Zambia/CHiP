(function (angular) {
    var UpdateModuleController = function ($uibModal, $uibModalInstance, topics, toaster, AuthenticateService, APP_CONFIG, $rootScope, Mask, GeneralUtil, DocumentDAO, $filter, ENV) {
        let $ctrl = this;
        ...
        $ctrl.removeFile = (media) => {
            if (media.mediaName) {
                $ctrl.isRemove = true;
                DocumentDAO.removeFile(media.mediaName).then(() => {
