...
public class FormulaUtil {
        ...
        if (queFormBean.getAnswer() != null
            ...
            if (answer != null) {
                ...
                if (split.length > 2 && split[2].equalsIgnoreCase("Malnutrition")) {
                    ...
                    if (age != null && gender != null && latestWeight != null && latestWeight.trim().length() > 0 && !latestWeight.trim().equalsIgnoreCase("null")) {
                        if (GlobalTypes.FLAVOUR_CHIP.equalsIgnoreCase(BuildConfig.FLAVOR)) {
                            String weight = null;
                            if (latestWeight.contains("F/")) {
                                weight = latestWeight.replace("F/", "");
                            }
                            if (latestWeight.contains("T")) {
                                weight = latestWeight.replace("T", "");
                            }
                            if (weight != null && !weight.trim().equalsIgnoreCase("null")
                                    && !weight.trim().equalsIgnoreCase("")) {
                                if (GlobalTypes.FLAVOUR_CHIP.equalsIgnoreCase(BuildConfig.FLAVOR)) {
                                    setValue = UtilBean.findMalnutritionGradeZambia(gender, age, Float.parseFloat(weight));
                                } else {
                                    setValue = UtilBean.findMalnutritionGrade(gender, age, Float.parseFloat(weight));
                                }
                            }
                        } else {
                            if (GlobalTypes.FLAVOUR_CHIP.equalsIgnoreCase(BuildConfig.FLAVOR)) {
                                setValue = UtilBean.findMalnutritionGradeZambia(gender, age, Float.parseFloat(latestWeight));
                            } else {
    ...
    public static void generateMemberUUID(QueFormBean queFormBean) {
        if (SharedStructureData.relatedPropertyHashTable.get(UtilBean.getRelatedPropertyNameWithLoopCounter(RelatedPropertyNameConstants.MEMBER_UUID, queFormBean.getLoopCounter())) == null) {
            SharedStructureData.relatedPropertyHashTable.put(
                    UtilBean.getRelatedPropertyNameWithLoopCounter(RelatedPropertyNameConstants.MEMBER_UUID, queFormBean.getLoopCounter()),
                    UUID.randomUUID().toString());
            System.out.println("RUNTIME NEW MEMBER UUID == " + SharedStructureData.relatedPropertyHashTable.get(UtilBean.getRelatedPropertyNameWithLoopCounter(RelatedPropertyNameConstants.MEMBER_UUID, queFormBean.getLoopCounter())));
        }
    }

    public static void generateMemberUUIDWpd(QueFormBean queFormBean) {
        if (SharedStructureData.relatedPropertyHashTable.get(UtilBean.getRelatedPropertyNameWithLoopCounter(RelatedPropertyNameConstants.MEMBER_UUID_WPD, queFormBean.getLoopCounter())) == null) {
            SharedStructureData.relatedPropertyHashTable.put(
                    UtilBean.getRelatedPropertyNameWithLoopCounter(RelatedPropertyNameConstants.MEMBER_UUID_WPD, queFormBean.getLoopCounter()),
                    UUID.randomUUID().toString());
            System.out.println("RUNTIME NEW CHILD UUID IN WPD == " + SharedStructureData.relatedPropertyHashTable.get(UtilBean.getRelatedPropertyNameWithLoopCounter(RelatedPropertyNameConstants.MEMBER_UUID_WPD, queFormBean.getLoopCounter())));
        }
    }
    ...
    private static void setAadharScannedDataInRelatedPropertyHashtable
            (Map<String, String> aadharDataMap, int loopCounter) {
        SharedStructureData.relatedPropertyHashTable.put(
    ...
    private static void setAadharNumberFromAadharScanned(int questionIdForAadhar, Map<
            String, String> aadharDataMap) {
        String uid = aadharDataMap.get("uid");
        if (uid == null || uid.isEmpty()) {
            return;
        }
    ...
    private static void setDobDataFromAadharScanned(int questionIdForDob,
                                                    int questionIdForAgeDisplay, Map<String, String> aadharDataMap) {
    ...
    private static void setNameFromAadharScanned(int questionIdForFirstName,
                                                 int questionIdForMiddleName, int questionIdForLastName, Map<
            String, String> aadharDataMap) {
        String name = aadharDataMap.get("name");
    ...
    private static void setGenderFromAadharScanned(int questionIdForGender, Map<
            String, String> aadharDataMap) {
        String gender = aadharDataMap.get("gender");
        if (gender == null || gender.isEmpty()) {
            return;
    ...
    public static void displayEarlyRegistration(String[] split, QueFormBean queFormBean,
                                                boolean isValid) {
    ...
    public static void setPreFilledAsPerRelationWithHOF(String[] split, QueFormBean
            queFormBean) {
...
//    }
    ...
    public static void identifyHighRisk(String[] split, QueFormBean queFormBean) {
        if (split.length <= 1) {
            return;
        }
        ...
        String property = null;
        if (split.length == 3) {
            property = SharedStructureData.relatedPropertyHashTable.get(split[2]);
        }
        SharedStructureData.rchHighRiskService.identifyHighRisk(split[1], queFormBean.getAnswer(), UtilBean.getOptionsOrDataMap(queFormBean, false), property);
    }

    @SuppressLint("SetTextI18n")
    public static void checkMemberEligibility(String[] split, QueFormBean queFormBean) {
        if (split.length <= 1) {
            return;
        }
        String inclusion1 = SharedStructureData.relatedPropertyHashTable.get(split[1]);
        String inclusion2 = SharedStructureData.relatedPropertyHashTable.get(split[2]);
        String inclusion3 = SharedStructureData.relatedPropertyHashTable.get(split[3]);
        String exclusion1 = SharedStructureData.relatedPropertyHashTable.get(split[4]);
        String exclusion2 = SharedStructureData.relatedPropertyHashTable.get(split[5]);
        String exclusion3 = SharedStructureData.relatedPropertyHashTable.get(split[6]);
        String inclusion4 = SharedStructureData.relatedPropertyHashTable.get(split[7]);
        String inclusion5 = SharedStructureData.relatedPropertyHashTable.get(split[8]);
        String inclusion6 = SharedStructureData.relatedPropertyHashTable.get(split[9]);
        QueFormBean queFormBean1 = SharedStructureData.mapIndexQuestion.get(Integer.valueOf(split[10]));
        MaterialTextView materialTextView = null;
        if (queFormBean1 != null) {
            materialTextView = (MaterialTextView) queFormBean1.getQuestionTypeView();
        }
        if (inclusion1 != null && inclusion1.equalsIgnoreCase("1")
                && inclusion2 != null && inclusion2.equalsIgnoreCase("1")
                && inclusion3 != null && inclusion3.equalsIgnoreCase("1")
                && inclusion4 != null && inclusion4.equalsIgnoreCase("1")
                && inclusion5 != null && inclusion5.equalsIgnoreCase("1")
                && inclusion6 != null && inclusion6.equalsIgnoreCase("1")
                && exclusion1 != null && exclusion1.equalsIgnoreCase("2")
                && exclusion2 != null && exclusion2.equalsIgnoreCase("2")
                && exclusion3 != null && exclusion3.equalsIgnoreCase("2")) {
            if (queFormBean1 != null) {
                queFormBean1.setAnswer("1");
            }
            if (materialTextView != null) {
                materialTextView.setText(UtilBean.getMyLabel("Participant meet all inclusion criteria and exclusion criteria, and is eligible to enroll in the study"));
            }
        } else {
            if (queFormBean1 != null) {
                queFormBean1.setAnswer("2");
            }
            if (materialTextView != null) {
