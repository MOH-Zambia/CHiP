...
public interface HealthInfrastructureService {
    ...
    Map<Long, String> retrieveDistinctSpecificHealthInfraType(List<String> allowedHealthInfraType);

    List<HealthInfrastructureBean> retrieveHealthInfraListByLocationList(List<Integer> locationIds);
    HealthInfrastructureBean retrieveHealthInfraById(Long actualId);
