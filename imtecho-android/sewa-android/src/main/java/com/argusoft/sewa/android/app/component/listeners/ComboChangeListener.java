    ...
    public void onItemSelected(AdapterView<?> av, View view, int position, long l) {
        ...
        if (queFormBean.getFormulas() != null &&
            ...
            if (queFormBean.getAnswer() != null) {
                ...
                SharedStructureData.relatedPropertyHashTable.remove(UtilBean.getRelatedPropertyNameWithLoopCounter(queFormBean.getRelatedpropertyname(), queFormBean.getLoopCounter()));
            }
        }
    }
