...
import com.argusoft.sewa.android.app.component.TypeHealthInfrastructureComponent;
import com.argusoft.sewa.android.app.component.listeners.CheckBoxChangeListener;
import com.argusoft.sewa.android.app.component.listeners.StockRequestComponent;
...
public class FormGenerator {
    ...
    public static void generateQuestion(QueFormBean queFormBean, Context context) {
        ...
        if (!isBold) {
            ...
            if (queFormBean.getIsmandatory() != null && queFormBean.getIsmandatory().equalsIgnoreCase(GlobalTypes.TRUE)) {
                queFormBean.setQuestionView(MyStaticComponents.generateMandatoryQuestionView(queFormBean.getHelpvideofield(), queFormBean.getHint(), context, queFormBean.getQuestion()));
            } else {
    ...
    private static void generateQuestionTypeView(QueFormBean queFormBean, Context context) {
        ...
        if (queType.equalsIgnoreCase(GlobalTypes.COMBO) || queType.equalsIgnoreCase(GlobalTypes.COMBO_BOX_DYNAMIC_SELECT)) {
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.SERVICE_DATE_BOX)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getCustomDatePickerForServiceDate(queFormBean, context));
        } else if (queType.equalsIgnoreCase(GlobalTypes.SERVICE_DATE_BOX_FP)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getCustomDatePickerForServiceDateFP(queFormBean, context));
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.CUSTOM_PPG_DATA_PICKER)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getPPGImageView(queFormBean, context));
            ...
            if (validations != null && !validations.isEmpty()) {
                for (ValidationTagBean validation : validations) {
                    if (validation.getMethod().equalsIgnoreCase(FormulaConstants.NUMERIC) || validation.getMethod().equalsIgnoreCase(FormulaConstants.GREATER_THAN_0)) {
                        ...
                        break;
                    } else if (validation.getMethod().equalsIgnoreCase(FormulaConstants.ALL_CAPS)) {
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.HINT_TEXT_BOX)) {
            int inputType = -1;
            List<ValidationTagBean> validations = queFormBean.getValidations();
            if (validations != null && !validations.isEmpty()) {
                for (ValidationTagBean validation : validations) {
            ...
            TextInputLayout editText = MyStaticComponents.getEditText(context, queFormBean.getHint(), -1, queFormBean.getLength(), inputType);
            if (editText.getEditText() != null) {
                editText.getEditText().setOnFocusChangeListener(new TextFocusChangeListener(context, queFormBean));
            }
            String defaultValue;
            ...
            if (editText.getEditText() != null) {
                editText.getEditText().setOnFocusChangeListener(new TextFocusChangeListener(context, queFormBean));
                editText.getEditText().addTextChangedListener(new TextChangeListener(editText.getEditText(), queFormBean));
            }
            String defaultValue;
            if (queFormBean.getRelatedpropertyname() != null && queFormBean.getRelatedpropertyname().trim().length() > 0) {
                String relatedPropertyName = queFormBean.getRelatedpropertyname().trim();
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.BARCODE_SCAN)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getBarcodeScannerView(context, queFormBean, -1));
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.HEIGHT_BOX)) {
//            boolean isCombo = true;
//            boolean isDateShow = false;
//            if (queFormBean.getDatamap() != null && queFormBean.getDatamap().trim().length() > 0) {
//                String[] dataMap = UtilBean.split(queFormBean.getDatamap().trim(), GlobalTypes.KEY_VALUE_SEPARATOR);
...
//                checkBoxLabel = queFormBean.getSubform().trim();
//            }
            queFormBean.setQuestionTypeView(MyDynamicComponents.getHeightBox(context, queFormBean, -1));
            ...
            if (labelFormula != null) {
                labelFormula.setTextIsSelectable(true);
            }
            ...
            queFormBean.setQuestionTypeView(multiSelect);
        } else if (queType.equalsIgnoreCase(GlobalTypes.STOCK_REQUEST_COMP)) {
            queFormBean.setQuestionTypeView(new StockRequestComponent(context, queFormBean));
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.TABLE_VIEW)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getTableLayout(context, queFormBean));
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.Z_BLOOD_PRESSURE_MEASUREMENT)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getBloodPressureBoxZambia(context, queFormBean, -1));
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.CHECKBOX_TEXT_WATCHER_BOX)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getCheckBoxWithTextWatcherBox(context, queFormBean));
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.TYPE_HEALTH_INFRASTRUCTURE_COMPONENT)) {
            queFormBean.setQuestionTypeView(new TypeHealthInfrastructureComponent(context, queFormBean));
            ...
            queFormBean.setQuestionTypeView(MyDynamicComponents.getImmunisationGivenComponentZambia(context, queFormBean));
        ...
        } else if (queType.equalsIgnoreCase(GlobalTypes.BMI_COMPONENT_ADOLESCENT)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getBMIComponentAdolescent(context, queFormBean));
        } else if (queType.equalsIgnoreCase(GlobalTypes.ADOLESCENT_HB_COMPONENT)) {
            queFormBean.setQuestionTypeView(MyDynamicComponents.getHBComponent(context, queFormBean));
        } else if (queType.equalsIgnoreCase(GlobalTypes.IMMUNISATION_SELECTION_COMPONENT)) {
