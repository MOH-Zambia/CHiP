...
public class SewaConstants {
    ...
    public static String getDirectoryPath(Context context, String dirName) {
        ...
        if (context == null) {
            ...
            } else if (BuildConfig.FLAVOR.equals(GlobalTypes.FLAVOUR_UTTARAKHAND)) {
    ...
    public static final String SERVER_ISSUE="Server unreachable. Please try again after sometime";
    ...
    public static final String IS_FROM_LOGIN_FLOW = "IS_FROM_LOGIN_FLOW";
