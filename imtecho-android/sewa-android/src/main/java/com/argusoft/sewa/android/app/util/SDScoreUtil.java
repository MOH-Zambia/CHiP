...
public class SDScoreUtil {
    ...
    static {
        ...
        sdScoreMapForBoys.put(120, "15.5~17.1~18.6~222");
        sdScoreMapForBoys.put(121, "15.5~17.1~18.6~20.4~22.4");
        sdScoreMapForBoys.put(122, "15.5~17.1~18.6~20.4~22.4");
    }
    ...
    static {
        ...
        sdScoreMapForGirls.put(121, "15.6~17.3~18.9~20.7~22.8");
        sdScoreMapForGirls.put(122, "15.6~17.3~18.9~20.7~22.8");
    }
    ...
    public static String getSDScoreForDisplay(String sdScore) {
        if (sdScore != null && !sdScore.isEmpty()) {
            switch (sdScore) {
                case "SD4":
                    return "Less than -4 (Severe Acute Malnutrition)";
                case "SD3":
                    return "-4 to -3 (Severe Acute Malnutrition)";
                case "SD2":
                    return "-3 to -2 (Moderate Acute Malnutrition)";
                case "SD1":
                    return "-2 to -1";
                case "MEDIAN":
                    return "MEDIAN";
