...
public class SharedStructureData {
    ...
    public static void setDbContext(Context dbContext) {
        SharedStructureData.dbContext = dbContext;
    }
    ...
    public static final List<String> researcherSheets = new ArrayList<>();
    public static final List<String> utDataCollectorSheets = new ArrayList<>();
    ...
    public static HealthInfraTypeLocationService healthInfraTypeLocationService;
    ...
    public static boolean isGenerateQr = false;

    public static Map<Integer, Map<String, Date>> vaccineGivenDateMapList = new HashMap<>();
    ...
    public static Map<String, String> imageFilesToUpload = new HashMap<>();
    public static List<QueFormBean> finalFilesToUpload = new ArrayList();
    ...
    public static List<String> highRiskConditions = new ArrayList<>();

    public static boolean isOpenedFromNotification = false;
    public static String ecgToken = "";
    ...
    public static void setEcgToken(String ecgToken) {
        SharedStructureData.ecgToken = ecgToken;
    }
    ...
    static {
        ...
        groupAwwSheets();
        groupFHWSheets();
        groupResearcherSheets();
        groupDataCollectorSheets();
    ...
    public static Map<String, Date> getVaccineGivenDateMap(Integer loopCounter) {
        if (!vaccineGivenDateMapList.containsKey(loopCounter))
            vaccineGivenDateMapList.put(loopCounter, new HashMap<>());

        return vaccineGivenDateMapList.get(loopCounter);
    }
    ...
    public static void resetSharedStructureData() {
        ...
        ismapUpdate = false;
        isGenerateQr = false;
        imageFilesToUpload.clear();
    }

    private static void groupFHWSheets() {
        fhwSheets.clear();
        fhwSheets.add(FormConstants.FAMILY_HEALTH_SURVEY);
        fhwSheets.add(FormConstants.CAM_FHS);
        fhwSheets.add(FormConstants.CAM_ANC);
        fhwSheets.add(FormConstants.CAM_WPD);
        fhwSheets.add(FormConstants.CAM_RIM);
        fhwSheets.add(FormConstants.CAM_FHS_MEMBER_UPDATE);
        fhwSheets.add(FormConstants.CFHC);
        fhwSheets.add(FormConstants.HOUSE_HOLD_LINE_LIST_NEW);
        fhwSheets.add(FormConstants.FHS_MEMBER_UPDATE_NEW);
        fhwSheets.add(FormConstants.FAMILY_FOLDER);
        fhwSheets.add(FormConstants.FAMILY_FOLDER_MEMBER_UPDATE);
        ...
        fhwSheets.add(FormConstants.CHIP_FP_FOLLOW_UP);
        ...
        fhwSheets.add(FormConstants.DNHDD_FHW_SAM_SCREENING);
        fhwSheets.add(FormConstants.DNHDD_CMAM_FOLLOWUP);
        fhwSheets.add(FormConstants.NCD_CVC_CLINIC);
        fhwSheets.add(FormConstants.NCD_CVC_HOME);
        fhwSheets.add(FormConstants.CHIP_ACTIVE_MALARIA);
        fhwSheets.add(FormConstants.CHIP_PASSIVE_MALARIA);
        fhwSheets.add(FormConstants.CHIP_ACTIVE_MALARIA_FOLLOW_UP);
        fhwSheets.add(FormConstants.MALARIA_NON_INDEX);
        fhwSheets.add(FormConstants.MALARIA_INDEX);
        fhwSheets.add(FormConstants.CHIP_TB);
        fhwSheets.add(FormConstants.CHIP_COVID_SCREENING);
        fhwSheets.add(FormConstants.CHIP_TB_FOLLOW_UP);
        fhwSheets.add(FormConstants.HIV_SCREENING);
        fhwSheets.add(FormConstants.HIV_SCREENING_FU);
        fhwSheets.add(FormConstants.HIV_POSITIVE);
        fhwSheets.add(FormConstants.STOCK_MANAGEMENT);
        fhwSheets.add(FormConstants.EMTCT);
        fhwSheets.add(FormConstants.SURVEILLANCE_PREG_REG);
        fhwSheets.add(FormConstants.SURVEILLANCE_PREG_OUTCOME);
        fhwSheets.add(FormConstants.SURVEILLANCE_CHILD_DEATH);
        fhwSheets.add(FormConstants.SURVEILLANCE_ADD_FAMILY);
    ...
    private static void groupAshaSheets() {
        ...
        ashaSheets.add(FormConstants.DNHDD_CMAM_FOLLOWUP);
    }
    ...
    private static void groupUtDataCollectorSheets() {
        utDataCollectorSheets.clear();
        utDataCollectorSheets.add(FormConstants.SICKLE_CELL_SURVEY);
        utDataCollectorSheets.add(FormConstants.SICKLE_CELL_ADD_FAMILY);
        utDataCollectorSheets.add(FormConstants.SICKLE_CELL_ADD_NEW_MEMBER);
    }

    private static void groupResearcherSheets() {
        researcherSheets.clear();
        researcherSheets.add(FormConstants.NCD_MO_CONFIRMED);
        researcherSheets.add(FormConstants.NCD_URINE_TEST);
        researcherSheets.add(FormConstants.NCD_RETINOPATHY_TEST);
    }

    private static void groupDataCollectorSheets() {
        researcherSheets.clear();
        researcherSheets.add(FormConstants.ANEMIA_SURVEY);
        researcherSheets.add(FormConstants.ANEMIA_PROTOCOL_DEVIATION);
        researcherSheets.add(FormConstants.ANEMIA_CRF);
    }
    ...
    private static void gpsFeatureEnabledForms() {
        ...
        gpsEnabledForms.addAll(researcherSheets);
        gpsEnabledForms.addAll(utDataCollectorSheets);
    }
