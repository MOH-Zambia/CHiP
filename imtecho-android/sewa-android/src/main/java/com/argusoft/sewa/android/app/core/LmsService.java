...
public interface LmsService {
    ...
    Boolean isQuizCompleted(Integer courseId, Integer moduleId, Integer lessonId);
    ...
    boolean isQuizCompleted(Integer courseId, Integer moduleId, Integer lessonId, Integer questionTypeId);
