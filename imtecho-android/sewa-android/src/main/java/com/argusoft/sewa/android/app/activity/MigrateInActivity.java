...
public class MigrateInActivity extends MenuActivity implements View.OnClickListener {
    ...
    private Boolean checkValidationForMemberQuestionScreen() {
        ...
        if (bankAccountEditText != null && bankAccountEditText.getEditText() != null
        ...
        if (healthIdEditText != null && healthIdEditText.getEditText() != null
        ...
        if (ifscEditText != null && ifscEditText.getEditText() != null
    ...
    private void addSearchTextBoxForFamily() {
        if (searchBox == null) {
            searchBox = new SearchComponent(context, null, LabelConstants.SEARCH_FAMILY, null, null, null, null);
    ...
    public void retrieveFamilyListFromDB(String search) {
        if (Objects.equals(qrScanFilter.get(FieldNameConstants.IS_QR_SCAN), "true") &&
                qrScanFilter.containsKey(FieldNameConstants.FAMILY_ID))
            search = qrScanFilter.get(FieldNameConstants.FAMILY_ID);
    ...
    private void saveMigrationIn() {
        ...
        if (middleNameEditText != null && middleNameEditText.getEditText() != null
        ...
        if (phoneEditText != null && phoneEditText.getEditText() != null
        ...
        if (migratedFromGujaratRadioGroup != null && migratedFromGujaratRadioGroup.getCheckedRadioButtonId() == RADIO_BUTTON_ID_YES) {
        ...
        if (stayingWithFamilyRadioGroup != null && stayingWithFamilyRadioGroup.getCheckedRadioButtonId() == RADIO_BUTTON_ID_YES) {
