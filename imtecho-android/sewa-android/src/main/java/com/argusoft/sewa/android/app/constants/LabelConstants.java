...
public class LabelConstants {
    ...
    public static final String NO_FEATURE_FOUND = "No Feature Found";
    public static final String CHOOSE_LANGUAGE = "Choose Language";
    public static final String CHOOSE_A_LANGUAGE = "Choose a language";
    public static final String FAILED_TO_FETCH_LANGUAGE_PLEASE_TRY_AGAIN = "Failed to fetch languages, please try again after sometime";
    public static final String NO_LANGUAGES_FOUND = "No Languages Found";
    ...
    public static final String INTERNET_CONNECTION_REQUIRED_FOR_LANGUAGE_CHANGE = "You are offline. Please turn on internet or connect to wifi for language change.";
    public static final String INTERNET_CONNECTION_REQUIRED_FOR_FETCHING_DATA = "You are offline. Please turn on internet or connect to wifi";
    ...
    public static final String SICKLE_CELL_ASSIGNED_FAMILIES_COUNT = "Assigned Families Count for sickle cell survey: ";
    public static final String SICKLE_CELL_UPDATED_FAMILIES_COUNT = "Updated Families Count for sickle cell survey: ";
    public static final String SURVEILLANCE_ASSIGNED_FAMILIES_COUNT = "Assigned Families Count for surveillance: ";
    public static final String SURVEILLANCE_UPDATED_FAMILIES_COUNT = "Updated Families Count for surveillance: ";
    ...
    public static final String CHARDHAM_TOURIST_COUNT = "Chardham tourist count : ";
    public static final String USER_HEALTH_INFRA_COUNT = "User health infra count : ";
    ...
    public static final String STOCK_INVENTORY_COUNT = "Stock Inventory Count : ";
    public static final String OCR_FORM_COUNT = "OCR forms Count : ";
    ...
    public static final String ALL_HEALTH_INFRA_TYPE_LOCATION_COUNT = "All Health Infra Type Location Count : ";
    ...
    public static final String LMS_COURSES_COUNT = "Lms courses count : ";
    public static final String LMS_USER_META_DATA_COUNT = "Lms user metadata count : ";
    public static final String MO_CONFIRMED_COUNT = "Mo confirmed member count : ";
    public static final String DRUG_INVENTORY_COUNT = "Drug inventory count : ";

    public static final String NCD_MEMBER_COUNT = "NCD members count : ";

    public static final String ANEMIA_MEMBER_COUNT = "Anemia members count : ";
    public static final String HU_MEMBER_COUNT = "Hydroxyurea members count : ";

    public static final String AADHAR_NUMBER = "AADHAAR Number";
    public static final String MOBILE_NUMBER = "Mobile number";
    public static final String VACCINE_NOTE = "**Green indicates due now, Red indicates missed";
    ...
    public static final String CH_MEMBER_REGISTERED = "REGISTERED";
    ...
    public static final String SEARCH_FAMILY_BY_HOUSE_NUMBER_OR_ADDRESS = "Search Family (By House No. or Address)";
    ...
    public static final String GPS_SERVICE_NOT_STARTED_ALERT_CHARDHAM = "Location Service is not enabled. Enable it to navigate towards health infrastructure";

    public static final String SELECT_FAMILY = "Select Family";
    public static final String SELECT_MEMBER = "Select a Member";
    public static final String REQUESTS = "Requests";
    public static final String MY_STOCK = "My Stock";
    public static final String SELECT_BENEFICIARY = "Select client";
    ...
    public static final String ABHA_NUMBER_ALREADY = "Abha Number is already linked.";
    ...
    public static final String SURVEY_FORM_ENTRY_COMPLETED = "The survey for this member has been submitted earlier.";
    ...
    public static final String SELECT_A_MEMBER_FOR_VERIFICATION = "Select a member for verification";
    ...
    public static final String CLOSE_FAMILY_FOLDER = "Are you sure want to close Family Folder?";
    public static final String CLOSE_FAMILY_AVAILABILITY = "Are you sure want to close Family Availability survey?";
    public static final String CLOSE_CHARDHAM_MEMBER_SCREENING = "Are you sure want to close pilgrim screening?";
    public static final String CHARDHAM_SCAN_FLOW = "Record vitals";
    public static final String EMERGENCY_REQUEST_DIALOGUE_TEXT = "Please select one of the below option in order to update the request status";
    public static final String EMERGENCY_SEND_REQUEST_AGAIN = "Do you want to send same request again to other available emergency supporters";
    ...
    public static final String DATA_QUALITY_RE_VERIFICATION_DETAILS = "Data Quality Re-verification";
    ...
    // Mobile Number Validation Activity
    ...
    public static final String MEMBER_ID_SEARCH = "Search by pilgrim ID";
    public static final String MEMBER_ID_OR_NAME_OR_HEALTH_ID_TO_SEARCH = "Member Id or Name or ABHA Address to Search";
    public static final String MEMBER_ID_OR_NAME_OR_TO_SEARCH = "Member Id or Name to Search";
    public static final String SERVICE_TYPE_SELECTION = "Select the type of Service";
    public static final String SELECT_THE_COHORT_OF_THE_PATIENT = "SELECT THE COHORT OF THE CLIENT";
    public static final String SERVICE_ELIGIBLE_COUPLES = "Eligible Couples";
    public static final String NEWLY_WED = "Newly Married Couples";
    ...
    public static final String SERVICE_MCH_REGISTER = "MCH Register";
    ...
    public static final String ZAMBIA_PROCEED_FROM_WPD_WHILE_ANC_ALERTS_PENDING_ALERT = "Some ANC visits are pending for this client. You will NOT be able to fill ANC after filling out POV. Do you want to proceed?";
    ...
    public static final String ON_HEALTH_SERVICE_ACTIVITY_CLOSE_ALERT = "Are you sure you want to close the Health Services view?";
    ...
    public static final String LMP = "LMP (Last Menstrual Period)";
    ...
    public static final String JSY_BENEFICIARY = "JSY client";
    public static final String KPSY_BENEFICIARY = "KPSY client";
    public static final String IAY_BENEFICIARY = "IAY client";
    ...
    // AssignFamily Activity
    public static final String SEARCH = "Search";
    public static final String APPLY_FILTERS = "Apply Filter";
    ...
    public static final String CHECK_TO_BENEFICIARY_MIGRATED_OUT_OF_STATE = "Please check if client has been migrated to Out of State";
    ...
    public static final String CBV_NAME = "CBV Name";
    ...
    public static final String VILLAGE_SELECTION_REQUIRED_ALERT_FOR_BENEFICIARY = "Please select village for client";
    public static final String ASHA_AREA_SELECTION_REQUIRED_ALERT_FOR_BENEFICIARY = "Please select ASHA area for client";
    public static final String CONFORMATION_TO_MIGRATION_OUT_OF_GUJARAT_FOR_BENEFICIARY = "Has the client migrated from Gujarat?";
    public static final String ENTER_LOCATION_DETAILS_FOR_MIGRATED_BENEFICIARY = "Enter location details from where the client has migrated";
    ...
    public static final String MIGRATED_IN_BENEFICIARY = "Migrated In a client";
    public static final String ENTER = "Enter";
    public static final String IS_NOT_CORRECT = "is not correct";
    public static final String CONFORMATION_TO_PREGNANCY_OF_BENEFICIARY = "Is the client pregnant?";
    ...
    public static final String CONFORMATION_TO_BENEFICIARY_STAYING_WITH_FAMILY_IN_VILLAGE = "Is the client staying with a family in the village?";
    public static final String SEARCH_AND_SELECT_FAMILY_FOR_BENEFICIARY = "Please search and select family for the client";
    public static final String FOR_BENEFICIARY = "for client";
    ...
    // Family Migration In Conformation
    ...
    public static final String SELECT_THE_MEMBERS_WHOM_YOU_WANT_TO_SPLIT = "Select the members whom you want to split";
    public static final String NOT_SELECTED_TO_MOVE_THE_HEAD_FROM_THE_FAMILY_TO_NEW_SPLIT_FAMILY = "You are about to split members without head of family please select new head of family";
    ...
    // FHW Family Migration Confirmation
    ...
    public static final String PLEASE_ENTER_BOTH_DATES = "Please enter both dates or member unique Id";
    public static final String TWELVE_DIGIT_MEMBER_ID = "Member id should be of 12 digits";
    ...
    public static final String GEO_LOCATORS = "Geo Locator";
    public static final String EMERGENCY_CONTACTS = "Emergency Contacts";
    public static final String SELECT_AREA = "Select Area";

    // Work Register LineList
    ...
    public static final String WORK_LOG_FOR_ZAMBIA = "Work Log";
    // Announcement
    ...
    public static final String File_TAGS_TO_SEARCH = "File tags to Search";

    // Custom Mandatory Video Player
    ...
    // Home Screen
    //Title for HomeScreen Activities
    public static final String DASHBOARD = "Dashboard";
    public static final String IHRPTM = "IHRPTM";
    //Title for Common Activities
    ...
    public static final String SYNC_STATUS_TITLE = "Sync Satus";
    ...
    //Title for FHW Activities
    public static final String COMPREHENSIVE_FAMILY_HEALTH_CENSUS_TITLE = "Comprehensive Family Health Census";
    public static final String ANM_ASHA_DETAILS = "ANM/Asha Details";
    public static final String CFHC_TITLE = "CFHC";
    public static final String HOUSE_HOLD_LINE_LIST = "Household Line List";
    public static final String HOUSE_HOLD_LINE_LIST_NEW = "Household Line List New";
    public static final String STOCK_MANAGEMENT = "Stock Management";
    public static final String FAMILY_FOLDER = "Family Folder";
    public static final String FAMILY_LOCKED = "Locked Houses";
    ...
    //Title for RCH Activities
    public static final String MY_PEOPLE_TITLE = "My People";
    public static final String ADULT_BCG_VACCINATION_TITLE = "Adult BCG Vaccination";
    public static final String HEALTH_SERVICES = "Health Services";

    public static final String HIV_SERVICES = "HIV Services";
    public static final String TOURISTS_TITLE = "Pilgrims";
    public static final String SCREENING_HISTORY = "Screening History";

    public static final String SCREENING_REPORT = "Screening Report";
    public static final String RES_TITLE = "REQUEST EMERGENCY SUPPORT";
    public static final String RESPOND_TITLE = "RESPOND EMERGENCY REQUESTS";
    public static final String HEALTH_ADVISORY = "Health Advisory";
    ...
    public static final String CASE_STUDY_TITLE = "Case Study Scenario";
    ...
    public static final String NUTRITION_ALERTS = "Nutrition Alerts";
    ...
    public static final String NCD_WEEKLY_CLINIC_ACTIVITY = "NCD Confirmed Cases";

    public static final String NCD_CVC_ACTIVITY = "NCD CVC Details";
    //Title for NPCB Activities
    public static final String NPCB_SCREENING_TITLE = "NPCB Screening";
    //Title For CHO Activity
    public static final String MARK_PRESENCE_AT_HWC_TITLE = "Mark Presence @ HWC";
    //Title for Migration Activities
    ...
    public static final String TRAINING_REQUIRED_AND_PRACTICE = "Training is required to access this form. Please practice this feature in training mode.";
    public static final String PRACTICE_COMPLETED = "Your training for this feature has been completed successfully. You are already qualified to work in production.";
    public static final String PLEASE_WAIT_WHILE_LOADING_PRACTICE = "Please wait while we are loading the training mode.";
    public static final String PLEASE_WAIT_WHILE_LOADING_PRODUCTION = "Please wait while we are loading the production mode.";
    public static final String PLEASE_WAIT_WHILE_UPLOADING_FILE = "Please wait while we are uploading file.";
    public static final String NO_INTERNET_CONNECTION_AVAILABLE = "No internet connection is available.";
    public static final String GO_TO_TRAINING_MODE = "Go to training mode";
    ...
    public static final String BMI_CATEGORY = "BMI Category";
    ...
    // Display Morbidity
    public static final String BENEFICIARY_NAME = "Name of client";
    ...
    public static final String SAME_FORM_MSG_REFRESH_AND_TRY_AGAIN = "Selected service for this member has already been filled which is not synced with the server. Please refresh and try again.";
    ...
    public static final String CLOSE_THE_STOCK_REQUEST = "Are you sure to close the reuest process?";
    public static final String CLOSE_ECG_TEST = "Are you sure to close ECG Assessment?";
    ...
    public static final String WANT_TO_CLOSE_HIGH_RISK_BENEFICIARIES = "Are you sure want to close High Risk Beneficiaries?";
    ...
    public static final String PHONE_NUMBER_REQUIRED_ALERT = "Please enter phone number";
    ...
    public static final String DUE_NOW = "Due";
    ...
    public static final String EX_WEIGHT = "ex. 5.6 Kgs";
    ...
    public static final String DESCRIBE_EMERGENCY = "Describe Emergency";
    ...
    // Health Infrastructure Listener
    ...
    public static final String NUMBER_AND_PROPORTION_OF_TRUE_VALIDATION_BY_GVK_EMRI_CALL_CENTER = "Number and proportion of true validation by call center";
    ...
    public static final String SELECT_HIV_POSITIVE_WOMAN = "HIV Positive Woman";
    public static final String MALARIA_SCREENING = "member for malaria screening";
    public static final String MALARIA_POSITIVE_SCREENING = "member for malaria positive screening";
    public static final String COVID_SCREENING = "member for covid screening";
    public static final String TB_SCREENING = "member for tb screening";
    public static final String LBL_HIV_SCREENING = "member for HIV screening";
    public static final String SERVICE_MALARIA = "Malaria Screening";
    public static final String SERVICE_COVID_19 = "Covid 19 Screening";
    public static final String SERVICE_TB = "Tuberculosis Screening";
    ...
    public static final String HIV_SCREENING = "HIV Screening";
    public static final String KNOWN_POSITIVE = "Known Positive Members";
    public static final String POSITIVE_PREGNANT_WOMEN = "Positive Pregnant Women";
    ...
    public static final String PENDING_MEMBERS = "Pending Members";

    //LMS Related
    public static final String ADD_BOOKMARK = "Add Bookmark";
    public static final String LEARNING_MANAGEMENT_SYSTEM_TITLE = "Learning Management System";
    public static final String LMS_QUIZ_TITLE = "Learning Quiz";
    public static final String SELECT_COURSES = "Select a Course";
    public static final String NO_COURSES_AVAILABLE = "No courses are available.";
    public static final String CLOSE_LMS_ACTIVITY = "Are you sure want to close Learning management System?";
    public static final String COMPLETE_PREVIOUS_LESSONS = "Please complete previous lessons first";
    public static final String COMPLETE_PREVIOUS_QUIZ = "Please clear previous quiz";
    public static final String CLOSE_QUESTION_MODULE_ACTIVITY = "Are you sure want to cancel the test?";
    ...
    public static final String FEEDBACK_SUBMITTED = "Your feedback has been submitted successfully";
    public static final String RATE_LESSON = "Please rate the content of this lesson.";

    //LMS Progress Report Related
    public static final String LMS_PROGRESS_REPORT_TITLE = "LMS Progress Report";
    public static final String CLOSE_LMS_PROGRESS_REPORT_ACTIVITY = "Are you sure want to close LMS Progress Report?";


    public static final String CPHC = "CPHC";
    public static final String OUTSIDE = "OUTSIDE";
    public static final String YEAR_AND_MONTH_NOT_YET_ENTERED = "Year/month not yet entered";

    public static final String SCREENING_STATUS_RED = "RED";
    public static final String SCREENING_STATUS_GREEN = "GREEN";
    public static final String SCREENING_STATUS_YELLOW = "YELLOW";
    public static final String SCREENING_STATUS_TREATMENT = "TREATMENT";

    public static final String STATUS_PENDING = "Pending";
    public static final String SEARCH_TREATMENT = "Search treatment from list";
    public static final String SELECT_TREATMENT_CHIP = "Tap or search here to select from list";
    public static final String SOME_ERROR_OCCURRED_PLEASE_TRY_AGAIN = "Some error occurred, please try again after sometime";

    public static final String SCANNER_DATA = "qrScannerData";
    public static final String FAMILY_TEMP_LOCKED = "Temporarily Locked";
    public static final String FAMILY_PERM_LOCKED = "Permanently Locked";
    public static final String NEARBY_HOUSEHOLDS = "Nearby Households";
    public static final String ENTER_HEIGHT = "Please enter height";
    public static final String HEIGHT_BETWEEN_100_TO_175 = "Please Enter Height between 100 and 175 cms.";
    public static final String ENTER_WEIGHT = "Please enter weight";
    public static final String WEIGHT_BETWEEN_5_TO_70 = "Please Enter Weight between 5 and 70 Kgs.";
    public static final String HAEMOGLOBIN = "Haemoglobin (g/dl)";
    public static final String CONDITION_HB = "Condition";
    public static final String ENTER_VALID_HB = "Please enter valid haemoglobin";
    public static final String ENTER_VALID_VALUE_HB = "Please enter haemoglobin value between 3 to 17";
    public static final String HB_SEVERE = "Severe";
    public static final String HB_MODERATE = "Moderate";
    public static final String HB_MILD = "Mild";
    public static final String NO_RECORDS_FOUND = "No Records Found";


    public static final String PHOTO_CAPTURED_FAILED = "Image not captured, please try again...";
    ...
    public static String UNDILUTED = "ICT(Indirect Coombs Test)";
    public static String DCT = "DCT(Direct Coombs Test)";
    public static String HB_F = "HPLC- HbF";
    public static String HBA = "HPLC- HbA";
    public static String HBA2 = "HPLC- HbA2";
    public static String HBS = "HPLC- HbS";
    public static String PERIPHERAL_SMEAR = "PS(Peripheral Smear)";
    public static String S_CREATININE = "Creatinine";
    public static String AVAILABLE = "AVAILABLE";
    public static String MIGRATED = "MIGRATED";
    public static String POSITIVE = "POSITIVE";
    public static String NEGATIVE = "NEGATIVE";
    public static String NOTHING = "NOTHING";

    public static String ENTOMOLOGICAL_INVESTIGATION = "Entomological Investigation";
}