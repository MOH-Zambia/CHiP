...
public class MyComparatorUtil {
    ...
    public static final Comparator<ListValueBean> LIST_VALUE_BEAN_ORDER_COMPARATOR = (o1, o2) -> {
        if (o1.getListOrder() == null || o2.getListOrder() == null) {
            return 0;
        } else {
    ...
    public static final Comparator<OptionDataBean> OPTION_DATA_BEAN_ORDER_COMPARATOR = (o1, o2) -> {
        if (o1.getListOrder() == null || o2.getListOrder() == null) {
            return 0;
        } else {
            return o1.getListOrder() - o2.getListOrder();
