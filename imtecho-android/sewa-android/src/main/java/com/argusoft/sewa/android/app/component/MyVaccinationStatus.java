...
//                msg = "BCG should be given on date of birth";
//                break;
//            case RchConstants.HEPATITIS_B_0:
//                msg = "Hepatitis B 0 should be given on date of birth";
//                break;
//            default:
//                msg = "";
//                break;
//        }
//
//        MaterialTextView hint = MyStaticComponents.generateAnswerView(context, msg);
