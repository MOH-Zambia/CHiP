...
@EActivity
public class LmsSimulationActivity extends MenuActivity implements IGetCaseStudyInterface, CaseStudyQueAdapter.QuestionImageClickListener {
    ...
    public void setCaseStudyScreen() {
        ...
        if (sectionData != null && sectionData.getMediaType() != null && sectionData.getMediaId() != null) {
            ...
            SewaUtil.generateToast(context, "Something went wrong with media files");
        }
    ...
    private void setupViewPager(ViewPager2 viewPager) {
        ...
        CaseStudyQueAdapter caseStudyQueAdapter = new CaseStudyQueAdapter(this, this, lmsQuestionConfigDataBeanList, this, this);
        viewPager.setAdapter(caseStudyQueAdapter);
        viewPager.setPageTransformer((page, position) -> updatePagerHeightForChild(page, viewPager));
    ...
    private void updateNumberOfAttemptsForThisQuiz() {
        ...
        lmsUserMetaData.setCourseId(questionSet.getCourseId());
    ...
    @Override
    public void questionImageClickListener(String path) {
        Intent intent = new Intent(context, CustomImageViewerActivity_.class);
        intent.putExtra("path", path);
        startActivityForResult(intent, ActivityConstants.LMS_ACTIVITY_REQUEST_CODE);
    }
