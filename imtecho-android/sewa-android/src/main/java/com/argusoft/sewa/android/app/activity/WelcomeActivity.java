...
public class WelcomeActivity extends MenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivLogo.setImageResource(R.mipmap.chip_app_icon_round);
        tvDescription.setText(R.string.techo_description_chip);
    }
    ...
    public void checkPermissions() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU ){
            ...
            map.put(Manifest.permission.READ_MEDIA_AUDIO,
                    PermissionChecker.checkSelfPermission(getApplicationContext(),
                            Manifest.permission.READ_MEDIA_AUDIO));
            map.put(Manifest.permission.READ_MEDIA_VIDEO,
                    PermissionChecker.checkSelfPermission(getApplicationContext(),
    ...
    private void createAllDirectoryInsideAndroidData() {
        ...
        createDirIfNotExists(SewaConstants.getDirectoryPath(context, SewaConstants.DIR_DOCUMENTS));
    }
