...
public class BackgroundDownloadUtils {
    ...
    public static boolean isApkExistsOnLocal(Context context, String fileName) {
        ...
        Log.d(TAG, "Checking file exists length : " + apkFile.length());
                ...
                switch (status) {
                    ...
                    case DownloadManager.STATUS_SUCCESSFUL:
                        ...
                        if (!downloadedApk.exists()) {
                            ...
                            downloadedApk.renameTo(new File(SewaConstants.getDirectoryPath(context, SewaConstants.DIR_APK_DOWNLOADED), latestApkName));
    ...
    public static void startAppDownloading(Context context, String apkName, String downloadPath) {
