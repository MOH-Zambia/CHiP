...
public class ListItemDataBean {
    ...
    public ListItemDataBean(Integer medicineId, String medicineName, String medicineQty, String approvedQty, String approvedBy, String approvedOn, String status, String requestId) {
        this.medicineId = medicineId;
        this.medicineName = medicineName;
        this.medicineQuantity = medicineQty;
    ...
    public ListItemDataBean(String familyId, String memberId, String memberName, String rel, String relName, Boolean highlightView) {
        this.familyId = familyId;
        this.memberId = memberId;
        this.memberName = memberName;
        this.boldText = rel;
    ...
    public ListItemDataBean(Boolean highlightView, String familyId, String memberId, String memberName, String state, String boldText, String regularText) {
        this.familyId = familyId;
        this.memberId = memberId;
        this.memberName = memberName;
        this.boldText = boldText;
    ...
    public ListItemDataBean(String date, String boldText, String regularText, String visit, boolean isTaskOverDue, Boolean highlightView, boolean displayEarly, String state) {
        this.date = date;
        this.boldText = boldText;
        this.regularText = regularText;
        this.visit = visit;
    ...
    public int getPendingAbhaCount() {
        return pendingAbhaCount;
    }

    public void setPendingAbhaCount(int pendingAbhaCount) {
        this.pendingAbhaCount = pendingAbhaCount;
    }
    ...
    public void setMedicineName(String medicineId) {
        this.medicineName = medicineName;
    }
