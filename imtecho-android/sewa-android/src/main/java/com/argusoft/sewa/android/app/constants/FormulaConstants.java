...
public class FormulaConstants {
    ...
    public static final String GENERATE_MEMBER_UUID = "generatememberuuid";
    public static final String GENERATE_MEMBER_UUID_WPD = "generatememberuuidforwpd";
    public static final String AVAILABLE_TABLETS = "checkAvailableTablets";
    ...
    public static final String VALIDATION_NRC_NUMBER_FORMAT = "NRCNumberFormat";
    public static final String VALIDATION_PASSPORT_NUMBER_FORMAT = "passportNumberFormat";
    public static final String VALIDATION_BIRTH_CERTIFICATE_FORMAT = "birthCertificateFormat";
    ...
    public static final String VALIDATION_CHECK_MOBILE_NUMBER_ZAMBIA = "mobileNumberZambia";
    ...
    public static final String VALIDATE_DURATION = "validateDuration";
    ...
    public static final String VALIDATION_GREATER_THAN_EQUAL_RELATED_PROPERTY = "greaterThanEqRelatedProperty";
    public static final String VALIDATION_LESS_THAN_RELATED_PROPERTY = "lessThanRelatedProperty";
    ...
    public static final String VALIDATION_CHILD_AGE_WITH_PARENT = "checkChildAgeWithParent";
    ...
    public static final String VALIDATION_CHECK_AADHAR_CONSENT = "checkAadharConsent";
    ...
    public static final String FORMULA_CHECK_BETWEEN = "checkbetween"; // checkBetween
    ...
    public static final String FORMULA_CHECK_TIME_GAP_IN_WK_DAYS = "checktimegapinweekanddays"; // checkDateBetween
    ...
    public static final String FORMULA_CHECK_SURVEILLANCE_FAMILY_REVERIFICATION = "checksurveillancefamilyreverification"; // checkFamilyReverification
    ...
    public static final String FORMULA_IDENTIFY_RISKS_CBAC = "identifyriskforcbac"; // identifyHighRiskAnc
    public static final String FORMULA_SET_REFERRAL_REASON = "setreferralreason";
    public static final String FORMULA_SET_CANCER_REFERRAL_REASON = "setcancerreferralreason";
    ...
    public static final String FORMULA_CHECK_EQUALS_LOOP = "checkequalsloop"; // checkContainsLoop
    ...
    public static final String FORMULA_CHECK_NEW_SURVEILLANCE_FAMILY = "checknewsurveillancefamily"; // checkNewFamily
    ...
    public static final String FORMULA_ADD_MOTHER_LIST_UT = "addmotherlistut"; // addmotherlistut

    public static final String FORMULA_ADD_HUSBAND_LIST = "addhusbandlist"; // addHusbandList
    public static final String FORMULA_ADD_HUSBAND_LIST_UT = "addhusbandlistut"; // addHusbandListUt
    ...
    public static final String FORMULA_SET_NUTRITION_CATEGORY = "setnutritioncategory";
    ...
    public static final String FORMULA_CHECK_GREATER_THAN = "greaterthan";// lessThan
    public static final String FORMULA_CHECK_LESS_THAN_FLOAT_VALUE = "lessthanfloat"; // lessThan
    ...
    public static final String FORMULA_IDENTIFY_HIGH_RISKS_ADOLESCENT = "identifyhighriskadolescent"; // identifyHighRiskAnc
    public static final String FORMULA_SET_HAEMOGLOBIN = "sethaemoglobin";
    ...
    public static final String VALIDATION_CHECK_DATE = "checkDate";
    // Formulas
    ...
    public static final String FORMULA_SET_GENDER_BY_RELATION_WITH_HOF = "setgenderbyrelationwithhof"; // setGenderBasedOnRlationWithHOF
    public static final String FORMULA_FILTER_SELECTED_CHRONIC = "filteronlyselecteddiseases";
    public static final String FORMULA_SET_HOF_MOB_NUMBER_FOR_MINORS = "sethofmobilenumberforminors"; // setGenderBasedOnRlationWithHOF

    public static final String FORMULA_SET_DEFAULT_PROPERTY_LOOP = "setdefaultpropertyloop"; // setDefaultPropertyLoop

    public static final String FORMULA_DISPLAY_HIGH_RISK_DATA = "displayhighriskdata"; //displayHighRiskData
    public static final String FORMULA_IDENTIFY_HIGH_RISK = "identifyhighrisk";

    // Formula For Anemia Data collector Survey Eligibility - Sewa Rural
    public static final String FORMULA_CHECK_MEMBER_SURVEY_ELIGIBILITY = "checkmembereligibility";
