            ...
            switch (screenName) {
                case MEMBER_INFO_SCREEN:
                    ...
                    if (radioGroupForMemberQue.getCheckedRadioButtonId() == RADIO_BUTTON_ID_YES) {
                        ...
                        if (searchBox.getEditText() != null && searchBox.getEditText().getText().length() > 0
                ...
                case FAMILY_SELECTION_SCREEN:
                    if (searchBox.getEditText() == null || searchBox.getEditText().getText().toString().trim().length() == 0) {
