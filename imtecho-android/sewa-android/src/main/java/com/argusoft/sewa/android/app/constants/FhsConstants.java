...
public class FhsConstants {
    ...
    private static Map<String, String> lockedHouseLabel;
    ...
    public static final String RELATION_SON_IN_LAW = "SON_IN_LAW";
    public static final String RELATION_DAUGHTER_IN_LAW = "DAUGHTER_IN_LAW";
    public static final String RELATION_GRANDSON = "GRANDSON";
    public static final String RELATION_FATHER_IN_LAW = "FATHER_IN_LAW";
    public static final String RELATION_BROTHER_IN_LAW = "BROTHER_IN_LAW";
    public static final String RELATION_MOTHER_IN_LAW = "MOTHER_IN_LAW";
    public static final String RELATION_SISTER_IN_LAW = "SISTER_IN_LAW";
    ...
    public static final String GREAT_GRANDSON = "GREAT_GRANDSON";
    public static final String GREAT_GRANDDAUGHTER = "GREAT_GRANDDAUGHTER";
    ...
    public static final List<String> CHILDREN_RELATION = Collections.unmodifiableList(getChildrenRelations());
    public static final List<String> ELDER_RELATION = Collections.unmodifiableList(getElderRelations());
    ...
    private static List<String> getMaleRelation() {
        ...
        stringList.add(GREAT_GRANDSON);
        stringList.add(RELATION_FATHER_IN_LAW);
        stringList.add(RELATION_BROTHER_IN_LAW);
        return stringList;
    }

    private static List<String> getChildrenRelations() {
        stringList = new ArrayList<>();
        stringList.add(RELATION_SON);
        stringList.add(RELATION_NEPHEW);
        stringList.add(RELATION_SON_IN_LAW);
        ...
        stringList.add(GREAT_GRANDDAUGHTER);
        return stringList;
    }


    private static List<String> getElderRelations() {
        stringList = new ArrayList<>();
        stringList.add(RELATION_FATHER);
        stringList.add(RELATION_GRANDFATHER);
        stringList.add(RELATION_FATHER_IN_LAW);
        ...
        stringList.add(RELATION_MOTHER_IN_LAW);
        return stringList;
    }
    ...
    private static List<String> getFemaleRelation() {
        ...
        stringList.add(RELATION_GRANDDAUGHTER);
        stringList.add(GREAT_GRANDDAUGHTER);
        stringList.add(RELATION_SISTER_IN_LAW);
        return stringList;
    }
    ...
    public static final String FAMILY_TEMP_LOCKED = "TEMP_LOCKED";
    public static final String FAMILY_PERM_LOCKED = "PERM_LOCKED";
    public static final String FAMILY_ARCHIVED = "FAMILY_ARCHIVED";
    ...
    public static final List<String> FHS_INACTIVE_CRITERIA_MEMBER_STATES_FOR_ZAMBIA = Collections.unmodifiableList(getFhsInactiveCriteriaMemberStatesForZambia());
    ...
    private static List<String> getFhsInactiveCriteriaMemberStatesForZambia() {
        stringList = new ArrayList<>();
        stringList.add(IDSP_MEMBER_STATE_IDSP_TEMP);
        stringList.addAll(FHS_MIGRATED_CRITERIA_MEMBER_STATES);
        stringList.addAll(FHS_ARCHIVED_CRITERIA_MEMBER_STATES);
    ...
    public static String getLabelForLockedHouse(String constant) {
        if (constant == null)
            return null;

        if (lockedHouseLabel == null) {
            lockedHouseLabel = new HashMap<>();
            lockedHouseLabel.put(FAMILY_PERM_LOCKED, UtilBean.getMyLabel(LabelConstants.FAMILY_PERM_LOCKED));
            lockedHouseLabel.put(FAMILY_TEMP_LOCKED, UtilBean.getMyLabel(LabelConstants.FAMILY_TEMP_LOCKED));
        }

        if (lockedHouseLabel.containsKey(constant.trim())) {
            return lockedHouseLabel.get(constant.trim());
        }
        return constant;
    }
