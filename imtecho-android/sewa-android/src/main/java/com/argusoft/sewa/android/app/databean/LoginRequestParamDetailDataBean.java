...
public class LoginRequestParamDetailDataBean {
    ...
    private Long lastUpdateDateForNcdMember;
    private Long lastUpdateDateForAnemiaMember;
    private String lastUpdateDateForSickleCellFamily;
    private String lastUpdateDateForSurveillanceFamily;
    private Long lastUpdateDateForStockManagement;
    private Long lastUpdateDateForHUMember;
    ...
    public void setLastUpdateDateForSchoolMaster(String lastUpdateDateForSchoolMaster) {
        this.lastUpdateDateForSchoolMaster = lastUpdateDateForSchoolMaster;
    }

    public Long getLastUpdateDateForChildService() {
        return lastUpdateDateForChildService;
    }

    public void setLastUpdateDateForChildService(Long lastUpdateDateForChildService) {
        this.lastUpdateDateForChildService = lastUpdateDateForChildService;
    }
    ...
    public void setReadNotifications(List<Long> readNotifications) {
    ...
    public Long getLastUpdateDateForNcdMember() {
        return lastUpdateDateForNcdMember;
    }

    public void setLastUpdateDateForNcdMember(Long lastUpdateDateForNcdMember) {
        this.lastUpdateDateForNcdMember = lastUpdateDateForNcdMember;
    }

    public Long getLastUpdateDateForAnemiaMember() {
        return lastUpdateDateForAnemiaMember;
    }

    public void setLastUpdateDateForAnemiaMember(Long lastUpdateDateForAnemiaMember) {
        this.lastUpdateDateForAnemiaMember = lastUpdateDateForAnemiaMember;
    }

    public String getLastUpdateDateForSickleCellFamily() {
        return lastUpdateDateForSickleCellFamily;
    }

    public void setLastUpdateDateForSickleCellFamily(String lastUpdateDateForSickleCellFamily) {
        this.lastUpdateDateForSickleCellFamily = lastUpdateDateForSickleCellFamily;
    }

    public Long getLastUpdateDateForStockManagement() {
        return lastUpdateDateForStockManagement;
    }

    public void setLastUpdateDateForStockManagement(Long lastUpdateDateForStockManagement) {
        this.lastUpdateDateForStockManagement = lastUpdateDateForStockManagement;
    }

    public String getLastUpdateDateForSurveillanceFamily() {
        return lastUpdateDateForSurveillanceFamily;
    }

    public void setLastUpdateDateForSurveillanceFamily(String lastUpdateDateForSurveillanceFamily) {
        this.lastUpdateDateForSurveillanceFamily = lastUpdateDateForSurveillanceFamily;
    }

    public Long getLastUpdateDateForHUMember() {
        return lastUpdateDateForHUMember;
    }

    public void setLastUpdateDateForHUMember(Long lastUpdateDateForHUMember) {
        this.lastUpdateDateForHUMember = lastUpdateDateForHUMember;
    }
