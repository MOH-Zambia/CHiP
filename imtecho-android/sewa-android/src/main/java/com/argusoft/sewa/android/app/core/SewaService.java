...
public interface SewaService {
    ...
    List<UploadFileDataBean> getFileWorkLog(String checkSum);

    List<UploadFileDataBean> getFileByFormType(String formType, String checksum);

    List<UploadFileDataBean> getFilesToBeUploaded();
    ...
    void updateFamilyByUUID(HouseHoldLineListMobileDto familyDetails, FamilyBean familyBean);
