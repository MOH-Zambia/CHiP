...
public class GlobalTypes {
    ...
    public static final String SAVING_DATA = "Saving captured data...";
    ...
    public static final String USER_ROLE_SURVEYOR = "Surveyor";
    public static final String USER_ROLE_MASTER_TRAINER = "Master Trainer";
    ...
    public static final String CUSTOM_PPG_DATA_PICKER = "PPG";
    ...
    public static final String SERVICE_DATE_BOX = "SDB";
    public static final String SERVICE_DATE_BOX_FP = "SDBFP";
    ...
    public static final String HINT_TEXT_BOX = "HTB";
    ...
    public static final String HEIGHT_BOX = "HB";
    ...
    public static final String STOCK_REQUEST_COMP = "SRC";
    public static final String SINGLE_CHECK_BOX = "SCB";
    public static final String TABLE_VIEW = "TV";
    public static final String BLOOD_PRESSURE_MEASUREMENT = "BPM";
    public static final String Z_BLOOD_PRESSURE_MEASUREMENT = "ZBPM";
    ...
    public static final String DNHDD_HEALTH_INFRASTRUCTURE_COMPONENT = "DNHDDHIC";
    public static final String DISTRICT_HEALTH_INFRASTRUCTURE_COMPONENT = "DHIC";
    public static final String TYPE_HEALTH_INFRASTRUCTURE_COMPONENT = "THIC";
    public static final String CHILD_GROWTH_CHART_COMPONENT = "CGCC";
    public static final String IMMUNISATION_GIVEN_COMPONENT = "IGC";

    public static final String ADOLESCENT_HB_COMPONENT = "AHB";
    public static final String BMI_COMPONENT_ADOLESCENT = "BMIA";
    ...
    public static final String IMMUNISATION_SELECTION_COMPONENT = "ISC";
    public static final String VIEW_CBC_REPORT_COMPONENT = "CBCR";
    ...
    public static final String CHECKBOX_TEXT_WATCHER_BOX = "CTWB";
    public static final String TEXT_WATCHER_BOX = "TWB";
    public static final String QR_SCAN = "QRS";
    public static final String VIEW_LAB_REPORT_COMPONENT = "LBR";

    public static final String BARCODE_SCAN = "BARS";
    ...
    public static final String SEVERELY_MALNOURISHED = "Severely Malnourished";
    ...
    public static final String SELECT_KG = "-Select Kgs-";
    public static final String SELECT_GRAM = "-Select Grams-";
    public static final String SELECT_FEET = "-Select Feet-";
    public static final String SELECT_INCH = "-Select Inch-";
    ...
    public static final List<String> FEET_LIST = Collections.unmodifiableList(getFeetList());
    public static final List<String> INCH_LIST = Collections.unmodifiableList(getInchList());
    ...
    public static final List<String> RELATION_WITH_HOF_LIST = Collections.unmodifiableList(getRelationWithHofList());

    private static List<String> getRelationWithHofList() {
        List<String> stringList = new LinkedList<>();
        stringList.add(GlobalTypes.SELECT);
        stringList.add(FhsConstants.RELATION_FATHER);
        stringList.add(FhsConstants.RELATION_SON);
        stringList.add(FhsConstants.RELATION_HUSBAND);
        stringList.add(FhsConstants.RELATION_BROTHER);
        stringList.add(FhsConstants.RELATION_GRANDFATHER);
        stringList.add(FhsConstants.RELATION_NEPHEW);
        stringList.add(FhsConstants.RELATION_SON_IN_LAW);
        stringList.add(FhsConstants.RELATION_GRANDSON);
        stringList.add(FhsConstants.RELATION_FATHER_IN_LAW);
        stringList.add(FhsConstants.RELATION_BROTHER_IN_LAW);
        stringList.add(FhsConstants.RELATION_MOTHER);
        stringList.add(FhsConstants.RELATION_DAUGHTER);
        stringList.add(FhsConstants.RELATION_WIFE);
        stringList.add(FhsConstants.RELATION_SISTER);
        stringList.add(FhsConstants.RELATION_GRANDMOTHER);
        stringList.add(FhsConstants.RELATION_NIECE);
        stringList.add(FhsConstants.RELATION_DAUGHTER_IN_LAW);
        stringList.add(FhsConstants.RELATION_GRANDDAUGHTER);
        stringList.add(FhsConstants.RELATION_MOTHER_IN_LAW);
        stringList.add(FhsConstants.RELATION_SISTER_IN_LAW);
        return stringList;
    }

    private static List<String> getKiloList() {
        List<String> stringList = new LinkedList<>();
        stringList.add(GlobalTypes.SELECT_KG);
        stringList.add("0 kg");
        stringList.add("1 kg");
        stringList.add("2 kg");
        stringList.add("3 kg");
        ...
        stringList.add("8 kg");
        stringList.add("9 kg");
        stringList.add("10 kg");
        stringList.add("11 kg");
        stringList.add("12 kg");
        stringList.add("13 kg");
        stringList.add("14 kg");
        stringList.add("15 kg");
        stringList.add("16 kg");
        stringList.add("17 kg");
        stringList.add("18 kg");
        stringList.add("19 kg");
        stringList.add("20 kg");
        stringList.add("21 kg");
        stringList.add("22 kg");
        stringList.add("23 kg");
        stringList.add("24 kg");
        return stringList;
    }

    private static List<String> getGramList() {
        List<String> stringList = new LinkedList<>();
        stringList.add(GlobalTypes.SELECT_GRAM);
        stringList.add("0 to 99 gram");
        stringList.add("100 to 199 gram");
        stringList.add("200 to 299 gram");
        stringList.add("300 to 399 gram");
        stringList.add("400 to 499 gram");
        stringList.add("500 to 599 gram");
        stringList.add("600 to 699 gram");
        stringList.add("700 to 799 gram");
        stringList.add("800 to 899 gram");
        stringList.add("900 to 999 gram");
        return stringList;
    }

    private static List<String> getFeetList() {
        List<String> stringList = new LinkedList<>();
        stringList.add(GlobalTypes.SELECT_FEET);
        stringList.add("0 ft");
        stringList.add("1 ft");
        stringList.add("2 ft");
        stringList.add("3 ft");
    ...
    private static List<String> getInchList() {
        List<String> stringList = new LinkedList<>();
        stringList.add(GlobalTypes.SELECT_INCH);
        stringList.add("0 inch");
        stringList.add("1 inch");
        stringList.add("2 inch");
        stringList.add("3 inch");
        stringList.add("4 inch");
        stringList.add("5 inch");
        stringList.add("6 inch");
        stringList.add("7 inch");
        stringList.add("8 inch");
        stringList.add("9 inch");
        stringList.add("10 inch");
        stringList.add("11 inch");
        return stringList;
    }
    ...
    public static final int BARCODE_SCAN_ACTIVITY = 16667;
    ...
    public static final List<String> STATE_LIST = Collections.unmodifiableList(getStateList());
    ...
    private static LinkedList<String> getStateList() {
    ...
    //Flavor constant
    public static final String FLAVOUR_UTTARAKHAND = "uttarakhand";
    public static final String FLAVOUR_DNHDD = "dnhdd";
    public static final String FLAVOUR_MEDPLAT = "medplat";
    public static final String FLAVOUR_IMOMCARE = "imomcare";
    public static final String FLAVOUR_TELANGANA = "telangana";
