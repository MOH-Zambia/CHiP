...
public class FullFormConstants {
    ...
    public static String getFullFormOfCBACConstants(String constant) {
        ...
        if (cbacDetails == null) {
            ...
            cbacDetails.put("ATLEAST_30", "Atleast 30 minutes daily");
            cbacDetails.put("LESS_THAN_30", "Less than 30 minutes daily");
            cbacDetails.put("LEFT_EYE", "Left Eye");
            cbacDetails.put("RIGHT_EYE", "Right Eye");
            cbacDetails.put("BOTH", "BOTH");
        }
    ...
    public static String getFullFormOfVaccines(String constant) {
        ...
        if (vaccinesFullNameMap == null) {
            ...
            vaccinesFullNameMap.put("OPV_4", "OPV 4");
            ...
            vaccinesFullNameMap.put("ROTA_VACCINE_1", "ROTA Vaccine 1");
            vaccinesFullNameMap.put("ROTA_VACCINE_2", "ROTA Vaccine 2");
            vaccinesFullNameMap.put("PCV_1", "PCV 1");
            vaccinesFullNameMap.put("PCV_2", "PCV 2");
            vaccinesFullNameMap.put("PCV_3", "PCV 3");
            vaccinesFullNameMap.put("DPT-HEPB-HIB_1", "DPT-HepB-Hib 1");
